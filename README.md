...
This package is up to date with the original dateparser until commit [c30d8c0][original-commit]. There are several behavior and implementation differences between this port and the original:
...
[original-commit]: https://github.com/scrapinghub/dateparser/tree/c30d8c0
