...
This package is up to date with the original dateparser until commit [d1ab41f][original-commit]. There are several behavior and implementation differences between this port and the original:
...
[original-commit]: https://github.com/scrapinghub/dateparser/tree/d1ab41f
