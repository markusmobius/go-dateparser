...
This package is up to date with the original dateparser until commit [8a06a7b][original-commit]. There are several behavior and implementation differences between this port and the original:
...
[original-commit]: https://github.com/scrapinghub/dateparser/tree/8a06a7b
