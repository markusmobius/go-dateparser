...
type SupplementaryData struct {
	DateOrder             string                       `json:"date-order,omitempty"              yaml:"date-order,omitempty"`
	...
	LocaleSpecific        map[string]SupplementaryData `json:"locale-specific,omitempty" yaml:"locale-specific,omitempty"`
}
