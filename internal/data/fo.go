...
func init() {
	fo_Locale = merge(nil, LocaleData{
		...
		RelativeType: map[string]string{
			...
			"seinasta mnð":    "1 month ago",
			"næsta manað":     "in 1 month",
			"seinastu vi":     "1 week ago",
			"næstu viku":      "in 1 week",
			"seinastu v":      "1 week ago",
			"henda mnð":       "0 month ago",
			"hesu viku":       "0 week ago",
			"næsta mnð":       "in 1 month",
			"i morgin":        "in 1 day",
			"næsta ar":        "in 1 year",
			"næstu vi":        "in 1 week",
			"hesu vi":         "0 week ago",
		...
		ExactCombinedMatcher: matchExact8ef31bd78758d676bd9a871b96fbd7c97acab2632915b0aeec1d85a482cb7e9b,
		KnownWords:           []string{"hendan minuttin", "seinasta manað", "henda manaðin", "seinastu viku", "friggjadagur", "hendan timan", "seinasta mnð", "leygardagur", "næsta manað", "seinastu vi", "næstu viku", "seinastu v", "sunnudagur", "henda mnð", "hesu viku", "manadagur", "mikudagur", "næsta mnð", "september", "desember", "hosdagur", "i morgin", "minuttur", "november", "næsta ar", "næstu vi", "tysdagur", "februar", "hesu vi", "manaður", "næstu v", "oktober", "august", "hesu v", "i fjør", "i gjar", "januar", "sekund", "april", "dagur", "i dag", "timar", "i ar", "juli", "juni", "mars", "timi", "vika", "apr", "aug", "des", "feb", "fri", "gmt", "hos", "jan", "jul", "jun", "ley", "mai", "man", "mar", "mik", "min", "mnð", "nov", "okt", "sek", "sep", "sun", "tys", "utc", "am", "ar", "da", "nu", "pm", "vi", " ", "'", "+", ",", "-", ".", "/", ":", ";", "@", "[", "]", "d", "m", "s", "t", "v", "z", "|"},
	})
