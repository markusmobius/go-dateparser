...
var uk_Locale = merge(nil, LocaleData{
	...
	Simplifications: []ReplacementData{
		{regexp.MustCompile(`(?i)(\A|\W|_)кілька хвилин(\z|\W|_)`), "${1}2 хвилини${2}"},
		{regexp.MustCompile(`(?i)(\A|\W|_)кілька секунд(\z|\W|_)`), "${1}44 секунди${2}"},
		{regexp.MustCompile(`(?i)(\A|\W|_)за чверть(\z|\W|_)`), "${1}15 хвилин${2}"},
		{regexp.MustCompile(`(?i)(\A|\W|_)^секунду(\z|\W|_)`), "${1}1 секунду${2}"},
		{regexp.MustCompile(`(?i)(\A|\W|_)^хвилину(\z|\W|_)`), "${1}1 хвилину${2}"},
		{regexp.MustCompile(`(?i)(\A|\W|_)^година(\z|\W|_)`), "${1}1 година${2}"},
		{regexp.MustCompile(`(?i)(\A|\W|_)^годину(\z|\W|_)`), "${1}1 годину${2}"},
		{regexp.MustCompile(`(?i)(\A|\W|_)опів на(\z|\W|_)`), "${1}30 хвилин${2}"},
	},
