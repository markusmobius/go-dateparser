...
var uk_Locale = merge(nil, LocaleData{
	...
	KnownWords:      []string{"наступного місяця", "наступного тижня", "минулого місяця", "наступного року", "минулого тижня", "цього місяця", "цієі хвилини", "післязавтра", "цього тижня", "цієі години", "цього року", "листопада", "позавчора", "понеділок", "приблизно", "березень", "вересень", "вівторок", "листопад", "п'ятниця", "протягом", "сьогодні", "березня", "близько", "вересня", "грудень", "жовтень", "квітень", "місяцем", "місяцям", "місяців", "секунда", "секунди", "секунду", "серпень", "тиждень", "травень", "хвилина", "хвилини", "хвилину", "червень", "вівтор", "година", "години", "годину", "грудня", "жовтня", "завтра", "квітня", "липень", "лютого", "місяць", "місяцю", "місяця", "місяці", "неділю", "неділя", "секунд", "середа", "середу", "серпня", "субота", "суботу", "січень", "тижнем", "тижнів", "травня", "хвилин", "червня", "четвер", "вчора", "годин", "зараз", "липня", "лютии", "назад", "неділ", "понед", "роком", "років", "серед", "субот", "січня", "тижня", "тижні", "торік", "учора", "через", "груд", "день", "днів", "доба", "доби", "жовт", "квіт", "лист", "роки", "року", "році", "серп", "тому", "трав", "черв", "gmt", "utc", "бер", "вер", "вів", "год", "гру", "дня", "дні", "діб", "жов", "кві", "лип", "лис", "лют", "міс", "нед", "пон", "рік", "сек", "сер", "суб", "січ", "тиж", "тра", "чер", "чет", "am", "pm", "вт", "дн", "дп", "за", "нд", "об", "пн", "пп", "пт", "сб", "ср", "хв", "чт", " ", "'", "+", ",", "-", ".", "/", ":", ";", "@", "[", "]", "z", "|", "г", "д", "м", "о", "р", "с", "т", "і"},
})
