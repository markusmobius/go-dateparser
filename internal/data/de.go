...
var de_Locale = merge(nil, LocaleData{
	...
	Simplifications: []ReplacementData{
		{regexp.MustCompile(`(?i)(\A|\W|_)sieben(\z|\W|_)`), "${1}7${2}"},
		{regexp.MustCompile(`(?i)(\A|\W|_)einem(\z|\W|_)`), "${1}1${2}"},
		{regexp.MustCompile(`(?i)(\A|\W|_)einer(\z|\W|_)`), "${1}1${2}"},
		{regexp.MustCompile(`(?i)(\A|\W|_)zwolf(\z|\W|_)`), "${1}12${2}"},
		{regexp.MustCompile(`(?i)(\A|\W|_)sechs(\z|\W|_)`), "${1}6${2}"},
		{regexp.MustCompile(`(?i)(\A|\W|_)zehn(\z|\W|_)`), "${1}10${2}"},
		{regexp.MustCompile(`(?i)(\A|\W|_)zwei(\z|\W|_)`), "${1}2${2}"},
		{regexp.MustCompile(`(?i)(\A|\W|_)drei(\z|\W|_)`), "${1}3${2}"},
		{regexp.MustCompile(`(?i)(\A|\W|_)vier(\z|\W|_)`), "${1}4${2}"},
		{regexp.MustCompile(`(?i)(\A|\W|_)funf(\z|\W|_)`), "${1}5${2}"},
		{regexp.MustCompile(`(?i)(\A|\W|_)acht(\z|\W|_)`), "${1}8${2}"},
		{regexp.MustCompile(`(?i)(\A|\W|_)neun(\z|\W|_)`), "${1}9${2}"},
		{regexp.MustCompile(`(?i)(\A|\W|_)ein(\z|\W|_)`), "${1}1${2}"},
		{regexp.MustCompile(`(?i)(\A|\W|_)elf(\z|\W|_)`), "${1}11${2}"},
	},
	...
	RxCombined:      regexp.MustCompile(`(?i)(\A|\W|_)(vor \d+ sekunden|in \d+ sekunden|vor \d+ minuten|vor \d+ monaten|vor \d+ sekunde|vor \d+ stunden|in \d+ minuten|in \d+ monaten|in \d+ sekunde|in \d+ stunden|vor \d+ jahren|vor \d+ minute|vor \d+ stunde|vor \d+ wochen|in \d+ jahren|in \d+ minute|in \d+ stunde|in \d+ wochen|vor \d+ monat|vor \d+ tagen|vor \d+ woche|in \d+ monat|in \d+ tagen|in \d+ woche|vor \d+ jahr|in \d+ jahr|vor \d+ min|vor \d+ sek|vor \d+ std|vor \d+ tag|vor \d+\s*h|vor \d+\s*m|vor \d+\s*s|in \d+ min|in \d+ sek|in \d+ std|in \d+ tag|vor \d+ wo|in \d+ wo|vor \d+ m|vor \d+ s|in \d+ m|in \d+ s)(\z|\W|_)`),
