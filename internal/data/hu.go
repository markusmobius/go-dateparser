...
func init() {
	hu_Locale = merge(nil, LocaleData{
		...
		RelativeTypeRegexes: []ReplacementData{
			...
			{regexp.MustCompile(`(?i)(\d+[.,]?\d*) honapja`), "$1 month ago"},
			{regexp.MustCompile(`(?i)(\d+[.,]?\d*) mperce`), "$1 second ago"},
			{regexp.MustCompile(`(?i)(\d+[.,]?\d*) napja`), "$1 day ago"},
			{regexp.MustCompile(`(?i)(\d+[.,]?\d*) oraja`), "$1 hour ago"},
			{regexp.MustCompile(`(?i)(\d+[.,]?\d*) perce`), "$1 minute ago"},
			{regexp.MustCompile(`(?i)(\d+[.,]?\d*) hete`), "$1 week ago"},
			{regexp.MustCompile(`(?i)(\d+[.,]?\d*) eve`), "$1 year ago"},
		},
		RxCombined:           regexp.MustCompile(`(?i)(\A|[^\pL\pM\d]|_)(\d+[.,]?\d* masodperccel ezelott|\d+[.,]?\d* honappal ezelott|\d+[.,]?\d* masodperc mulva|\d+[.,]?\d* perccel ezelott|\d+[.,]?\d* hettel ezelott|\d+[.,]?\d* nappal ezelott|\d+[.,]?\d* oraval ezelott|\d+[.,]?\d* evvel ezelott|\d+[.,]?\d* honap mulva|\d+[.,]?\d* perc mulva|\d+[.,]?\d* het mulva|\d+[.,]?\d* nap mulva|\d+[.,]?\d* ora mulva|\d+[.,]?\d* ev mulva|\d+[.,]?\d* honapja|\d+[.,]?\d* mperce|\d+[.,]?\d* napja|\d+[.,]?\d* oraja|\d+[.,]?\d* perce|\d+[.,]?\d* hete|\d+[.,]?\d* eve)(\z|[^\pL\pM\d]|_)`),
		RxExactCombined:      regexp.MustCompile(`(?i)^(\d+[.,]?\d* masodperccel ezelott|\d+[.,]?\d* honappal ezelott|\d+[.,]?\d* masodperc mulva|\d+[.,]?\d* perccel ezelott|\d+[.,]?\d* hettel ezelott|\d+[.,]?\d* nappal ezelott|\d+[.,]?\d* oraval ezelott|\d+[.,]?\d* evvel ezelott|\d+[.,]?\d* honap mulva|\d+[.,]?\d* perc mulva|\d+[.,]?\d* het mulva|\d+[.,]?\d* nap mulva|\d+[.,]?\d* ora mulva|\d+[.,]?\d* ev mulva|\d+[.,]?\d* honapja|\d+[.,]?\d* mperce|\d+[.,]?\d* napja|\d+[.,]?\d* oraja|\d+[.,]?\d* perce|\d+[.,]?\d* hete|\d+[.,]?\d* eve)$`),
		ExactCombinedMatcher: matchExact85ea42d7d4132adadff79dbbcbb9079f57528a5c78e7c001205ad0f2f83e5f09,
