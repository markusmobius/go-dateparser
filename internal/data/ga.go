...
var ga_Locale = merge(nil, LocaleData{
	...
	RxCombined:      regexp.MustCompile(`(?i)(\A|\W|_)(i gceann \d+ uair an chloig|\d+ uair an chloig o shin|i gceann \d+ seachtain|\d+ seachtain o shin|i gceann \d+ bhliain|i gceann \d+ noimead|i gceann \d+ soicind|i gceann \d+ bliain|\d+ bhliain o shin|\d+ noimead o shin|\d+ soicind o shin|\d+ bliain o shin|i gceann \d+ noim|i gceann \d+ scht|i gceann \d+ soic|i gceann \d+ uair|i gceann \d+ mhi|\d+ noim o shin|\d+ scht o shin|\d+ soic o shin|\d+ uair o shin|i gceann \d+ bl|i gceann \d+ la|i gceann \d+ mi|\d+ bhl o shin|\d+ mhi o shin|\d+ bl o shin|\d+ la o shin|\d+ mi o shin)(\z|\W|_)`),
	...
	RxKnownWords:    regexp.MustCompile(`(?i)^(.*?(?:\A|\W|_|\d))(an tseachtain seo chugainn|an bhliain seo chugainn|an tseachtain seo caite|an tscht seo chugainn|an bhl seo chugainn|an mhi seo chugainn|an tscht seo caite|an tseachtain seo|an mhi seo caite|deireadh fomhair|an bhliain seo|an noimead seo|an tscht seo|de domhnaigh|mean fomhair|an uair seo|de ceadaoin|de sathairn|an bhl seo|an mhi seo|bealtaine|de haoine|deardaoin|meitheamh|seachtain|anuraidh|de luain|de mairt|aibrean|amarach|feabhra|noimead|nollaig|samhain|soicind|bliain|eanair|lunasa|anois|aoine|dfomh|feabh|inniu|mairt|marta|meith|mfomh|beal|cead|dear|domh|inne|iuil|luan|noim|noll|samh|sath|scht|soic|uair|aib|ean|gmt|lun|utc|\+|\.|\[|\]|\||am|bl|la|mi|pm| |'|,|-|/|:|;|@|n|s|u|z)((?:\z|\W|_|\d).*)$`),
})
