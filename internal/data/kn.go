...
var kn_Locale = merge(nil, LocaleData{
	...
	RxCombined:      regexp.MustCompile(`(?i)(\A|\W|_)(\d+ ತಂಗಳುಗಳ ಹಂದ|\d+ ಸಕಂಡುಗಳ ಹಂದ|\d+ ಗಂಟಗಳ ಹಂದ|\d+ ತಂಗಳು ಹಂದ|\d+ ತಂಗಳುಗಳಲಲ|\d+ ನಮಷಗಳ ಹಂದ|\d+ ವರಷಗಳ ಹಂದ|\d+ ವಾರಗಳ ಹಂದ|\d+ ಸಕಂಡ‌ಗಳಲಲ|\d+ ತಂಗಳ ಹಂದ|\d+ ದನಗಳ ಹಂದ|\d+ ನಮಷದ ಹಂದ|\d+ ವರಷದ ಹಂದ|\d+ ವಾರದ ಹಂದ|\d+ ಸಕಂಡ ಹಂದ|\d+ ಸಕಂಡ‌ನಲಲ|\d+ ಗಂಟ ಹಂದ|\d+ ಗಂಟಗಳಲಲ|\d+ ದನದ ಹಂದ|\d+ ನಮಷಗಳಲಲ|\d+ ವರಷಗಳಲಲ|\d+ ವಾರಗಳಲಲ|\d+ ಗಂಟಯಲಲ|\d+ ತಂಗಳಲಲ|\d+ ದನಗಳಲಲ|\d+ ನಮಷದಲಲ|\d+ ವರಷದಲಲ|\d+ ವಾರದಲಲ|\d+ ದನದಲಲ)(\z|\W|_)`),
	...
	RxKnownWords:    regexp.MustCompile(`(?i)^(.*?(?:\A|\W|_|\d))(ಮುಂದನ ತಂಗಳು|ಕಳದ ತಂಗಳು|ಮುಂದನ ವರಷ|ಮುಂದನ ವಾರ|ಹಂದನ ವರಷ|ಅಕಟೂೕಬರ|ಈ ತಂಗಳು|ಕಳದ ವರಷ|ಕಳದ ವಾರ|ಗುರುವಾರ|ಪೂರವಾಹನ|ಭಾನುವಾರ|ಮಂಗಳವಾರ|ಶುಕರವಾರ|ಸೂೕಮವಾರ|ಅಪರಾಹನ|ಬುಧವಾರ|ಸಪಟಂಬರ|ಅಕಟೂೕ|ಈ ಗಂಟ|ಈ ನಮಷ|ಈ ವರಷ|ಈ ವಾರ|ಡಸಂಬರ|ತಂಗಳು|ನವಂಬರ|ಫಬರವರ|ಶನವಾರ|ಆಗಸಟ|ಇಂದು|ಏಪರಲ|ಗುರು|ಜನವರ|ಜುಲೖ|ಭಾನು|ಮಂಗಳ|ಮಾರಚ|ಶುಕರ|ಸಕಂಡ|ಸಪಟಂ|ಸೂೕಮ|gmt|utc|ಏಪರ|ಗಂಟ|ಜೂನ|ಡಸಂ|ನನನ|ನಮಷ|ನವಂ|ನಾಳ|ಫಬರ|ಬುಧ|ವರಷ|ವಾರ|\+|\.|\[|\]|\||am|pm|ಆಗ|ಈಗ|ಜನ|ದನ|ಮೕ|ಶನ| |'|,|-|/|:|;|@|z)((?:\z|\W|_|\d).*)$`),
})
