...
var km_Locale = merge(nil, LocaleData{
	...
	RxCombined:      regexp.MustCompile(`(?i)(\A|\W|_)(កនង​រយៈ​ពេល \d+ មោង|\d+ សបដាហទៀត|\d+ សបដាហ​មន|\d+ ថងៃ​​មន|\d+ នាទ​​មន|\d+ វនាទទៀត|\d+ វនាទ​មន|\d+ ឆនាទៀត|\d+ ឆនា​មន|\d+ ថងៃទៀត|\d+ ថងៃ​មន|\d+ នាទទៀត|\d+ នាទ​មន|\d+ មោងទៀត|\d+ មោង​មន|\d+ ខែទៀត|\d+ ខែមន)(\z|\W|_)`),
	...
	RxKnownWords:    regexp.MustCompile(`(?i)^(.*?(?:\A|\W|_|\d))(សបដាហ​ករោយ|សបដាហ​នេះ|ឆនា​ករោយ|ថងៃ​សអែក|សបដាហ​មន|ខែ​ករោយ|ឆនា​នេះ|ថងៃសអែក|ថងៃ​នេះ|ខែ​នេះ|ឆនា​មន|នាទនេះ|ពរហសបត|មោងនេះ|កកកដា|ខែ​មន|មសលមញ|វចឆកា|សបដាហ|អងគារ|អាទតយ|កញញា|កមភៈ|មករា|មថនា|មេសា|វនាទ|ឧសភា|gmt|utc|ចនទ|ឆនា|តលា|ថងៃ|នាទ|មនា|មោង|សករ|សហា|សៅរ|ឥឡវ|\+|\.|\[|\]|\||am|pm|ខែ|ធន|ពធ| |'|,|-|/|:|;|@|z)((?:\z|\W|_|\d).*)$`),
})
