...
var is_Locale = merge(nil, LocaleData{
	...
	RxKnownWords:    regexp.MustCompile(`(?i)^(.*?(?:\A|[^\pL\pM\d]|_|\d))(i siðasta manuði|i þessum manuði|i næsta manuði|i siðustu viku|i þessari viku|a siðasta ari|i siðasta man|i næstu viku|i þessum man|miðvikudagur|a næsta ari|a þessu ari|fimmtudagur|i næsta man|klukkustund|laugardagur|this minute|þriðjudagur|fostudagur|sunnudagur|manudagur|september|this hour|a morgun|desember|november|februar|manuður|oktober|sekunda|januar|minuta|agust|april|dagur|i dag|i gær|juli|juni|klst|mars|nuna|vika|agu|apr|des|feb|fim|fos|gmt|jan|jul|jun|lau|mai|man|mar|min|mið|nov|okt|sek|sep|sun|utc|þri|\+|\.|\[|\]|\||am|ar|eh|fh|pm| |'|,|-|/|:|;|@|d|v|z)((?:\z|[^\pL\pM\d]|_|\d).*)$`),
})
