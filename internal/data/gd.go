...
var gd_Locale = merge(nil, LocaleData{
	...
	RxCombined:      regexp.MustCompile(`(?i)(\A|\W|_)(an ceann \d+ uair a thide|\d+ uair a thide air ais|an ceann \d+ bhliadhna|an ceann \d+ seachdain|\d+ bhliadhna air ais|\d+ seachdain air ais|an ceann \d+ bliadhna|an ceann \d+ mhionaid|\d+ bliadhna air ais|\d+ mhionaid air ais|an ceann \d+ mionaid|\d+ mionaid air ais|an ceann \d+ mhiosa|an ceann \d+ latha|an ceann \d+ miosa|\d+ latha air ais|\d+ mhios air ais|an ceann \d+ diog|\d+ diog air ais|\d+ mios air ais|an \d+ sheachd|an \d+ seachd|o \d+ sheachd|an \d+ bhlia|an \d+ mhion|an \d+ mhios|o \d+ seachd|an \d+ blia|an \d+ diog|an \d+ mion|an \d+ mios|an \d+ uair|o \d+ bhlia|o \d+ mhion|o \d+ mhios|o \d+ blia|o \d+ diog|o \d+ mion|o \d+ mios|o \d+ uair|an \d+ la|o \d+ la)(\z|\W|_)`),
