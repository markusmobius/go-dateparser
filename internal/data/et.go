...
var et_Locale = merge(nil, LocaleData{
	...
	RxCombined:      regexp.MustCompile(`(?i)(\A|\W|_)(\d+ sekundi parast|\d+ minuti parast|\d+ nadala parast|\d+ aasta parast|\d+ paeva parast|\d+ sekundi eest|\d+ tunni parast|\d+ minuti eest|\d+ nadala eest|\d+ aasta eest|\d+ kuu parast|\d+ min parast|\d+ nad parast|\d+ paeva eest|\d+ sek parast|\d+ tunni eest|\d+ a parast|\d+ k parast|\d+ kuu eest|\d+ min eest|\d+ nad eest|\d+ p parast|\d+ s parast|\d+ sek eest|\d+ t parast|\d+ a eest|\d+ k eest|\d+ p eest|\d+ s eest|\d+ t eest)(\z|\W|_)`),
