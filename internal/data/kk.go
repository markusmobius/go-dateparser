...
var kk_Locale = merge(nil, LocaleData{
	...
	RxCombined:      regexp.MustCompile(`(?i)(\A|\W|_)(\d+ секундтан кеиін|\d+ минуттан кеиін|\d+ сағаттан кеиін|\d+ аптадан кеиін|\d+ жылдан кеиін|\d+ күннен кеиін|\d+ секунд бұрын|\d+ аидан кеиін|\d+ минут бұрын|\d+ сағат бұрын|\d+ апта бұрын|\d+ жыл бұрын|\d+ күн бұрын|\d+ мин бұрын|\d+ мин кеиін|\d+ сағ бұрын|\d+ сағ кеиін|\d+ сек бұрын|\d+ сек кеиін|\d+ аи бұрын|\d+ ап бұрын|\d+ ап кеиін|\d+ ж бұрын|\d+ ж кеиін)(\z|\W|_)`),
	...
	RxKnownWords:    regexp.MustCompile(`(?i)^(.*?(?:\A|\W|_|\d))(былтырғы жыл|келесі апта|биылғы жыл|келесі жыл|өткен апта|желтоқсан|келесі аи|осы минут|осы сағат|беисенбі|дүисенбі|жексенбі|осы апта|сеисенбі|сәрсенбі|қыркүиек|өткен аи|маусым|наурыз|осы аи|секунд|қараша|қаңтар|ақпан|бүгін|ертең|мамыр|минут|сағат|сенбі|сәуір|тамыз|шілде|қазан|қазір|апта|жұма|кеше|gmt|utc|ақп|жел|жыл|күн|мам|мау|мин|нау|сағ|сәу|там|шіл|қаз|қар|қаң|қыр|\+|\.|\[|\]|\||am|pm|аи|ап|бс|дс|жм|жс|сб|ср|сс| |'|,|-|/|:|;|@|z|ж|с)((?:\z|\W|_|\d).*)$`),
})
