...
func init() {
	mn_Locale = merge(nil, LocaleData{
		...
		RelativeTypeRegexes: []ReplacementData{
			{regexp.MustCompile(`(?i)(\d+[.,]?\d*) долоо хоногиин дараа`), "in $1 week"},
			{regexp.MustCompile(`(?i)(\d+[.,]?\d*) долоо хоногиин өмнө`), "$1 week ago"},
			{regexp.MustCompile(`(?i)(\d+[.,]?\d*) 7 хоногиин дараа`), "in $1 week"},
			{regexp.MustCompile(`(?i)(\d+[.,]?\d*) 7 хоногиин өмнө`), "$1 week ago"},
		...
		RxCombined:           regexp.MustCompile(`(?i)(\A|[^\pL\pM\d]|_)(\d+[.,]?\d* долоо хоногиин дараа|\d+[.,]?\d* долоо хоногиин өмнө|\d+[.,]?\d* 7 хоногиин дараа|\d+[.,]?\d* 7 хоногиин өмнө|\d+[.,]?\d* секундын дараа|\d+[.,]?\d* минутын дараа|\d+[.,]?\d* секундын өмнө|\d+[.,]?\d* 7х-иин дараа|\d+[.,]?\d* жилиин дараа|\d+[.,]?\d* минутын өмнө|\d+[.,]?\d* цагиин дараа|\d+[.,]?\d* өдриин дараа|\d+[.,]?\d* 7х-иин өмнө|\d+[.,]?\d* жилиин өмнө|\d+[.,]?\d* сарын дараа|\d+[.,]?\d* цагиин өмнө|\d+[.,]?\d* өдриин өмнө|\d+[.,]?\d* сарын өмнө|\d+[.,]?\d* мин дараа|\d+[.,]?\d* сек дараа|\d+[.,]?\d* мин өмнө|\d+[.,]?\d* сек өмнө|\d+[.,]?\d* ц дараа|\d+[.,]?\d* ц өмнө|\d+[.,]?\d* өдөрт)(\z|[^\pL\pM\d]|_)`),
		RxExactCombined:      regexp.MustCompile(`(?i)^(\d+[.,]?\d* долоо хоногиин дараа|\d+[.,]?\d* долоо хоногиин өмнө|\d+[.,]?\d* 7 хоногиин дараа|\d+[.,]?\d* 7 хоногиин өмнө|\d+[.,]?\d* секундын дараа|\d+[.,]?\d* минутын дараа|\d+[.,]?\d* секундын өмнө|\d+[.,]?\d* 7х-иин дараа|\d+[.,]?\d* жилиин дараа|\d+[.,]?\d* минутын өмнө|\d+[.,]?\d* цагиин дараа|\d+[.,]?\d* өдриин дараа|\d+[.,]?\d* 7х-иин өмнө|\d+[.,]?\d* жилиин өмнө|\d+[.,]?\d* сарын дараа|\d+[.,]?\d* цагиин өмнө|\d+[.,]?\d* өдриин өмнө|\d+[.,]?\d* сарын өмнө|\d+[.,]?\d* мин дараа|\d+[.,]?\d* сек дараа|\d+[.,]?\d* мин өмнө|\d+[.,]?\d* сек өмнө|\d+[.,]?\d* ц дараа|\d+[.,]?\d* ц өмнө|\d+[.,]?\d* өдөрт)$`),
		ExactCombinedMatcher: matchExact57c05a0fb182fe8d24592fc4cb5e6ee5e05790a95a85f71623a00ed54492bc6f,
		KnownWords:           []string{"арван хоердугаар сар", "өнгөрсөн долоо хоног", "арван нэгдүгээр сар", "зургаадугаар сар", "ирэх долоо хоног", "өнгөрсөн 7 хоног", "гуравдугаар сар", "долоодугаар сар", "дөрөвдүгээр сар", "зургадугаар сар", "энэ долоо хоног", "аравдугаар сар", "наимдугаар сар", "хоердугаар сар", "долдугаар сар", "нэгдүгээр сар", "тавдугаар сар", "есдүгээр сар", "ирэх 7 хоног", "өнгөрсөн жил", "өнгөрсөн сар", "долоо хоног", "энэ 7 хоног", "энэ минут", "10-р сар", "11-р сар", "12-р сар", "ирэх жил", "ирэх сар", "1-р сар", "2-р сар", "3-р сар", "4-р сар", "5-р сар", "6-р сар", "7 хоног", "7-р сар", "8-р сар", "9-р сар", "маргааш", "энэ жил", "энэ сар", "энэ цаг", "өнөөдөр", "өчигдөр", "баасан", "лхагва", "мягмар", "секунд", "бямба", "даваа", "минут", "пүрэв", "одоо", "өдөр", "gmt", "utc", "жил", "мин", "ням", "сар", "сек", "цаг", "7х", "am", "pm", "ба", "бя", "да", "лх", "мя", "ня", "пү", "үх", "үө", " ", "'", "+", ",", "-", ".", "/", ":", ";", "@", "[", "]", "z", "|", "ц"},
	})
}
