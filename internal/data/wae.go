...
var wae_Locale = merge(nil, LocaleData{
	...
	RxCombined:      regexp.MustCompile(`(?i)(\A|[^\pL\pM\d]|_)(vor \d+ sekunde|vor \d+ minuta|vor \d+ minute|vor \d+ sekund|vor \d+ stunde|i \d+ sekunde|vor \d+ manet|vor \d+ stund|cor \d+ wuca|i \d+ minuta|i \d+ minute|i \d+ sekund|i \d+ stunde|vor \d+ wuca|cor \d+ jar|i \d+ manet|i \d+ stund|vor \d+ jar|vor \d+ tag|i \d+ wuca|i \d+ jar|i \d+ tag)(\z|[^\pL\pM\d]|_)`),
