...
var dz_Locale = merge(nil, LocaleData{
	...
	RxCombined:      regexp.MustCompile(`(?i)(\A|\W|_)(བངན་ཕག་ \d+ ཧ་མ་|བངན་ཕག་ \d+ ནང་|ལ་འཁར་ \d+ ཧ་མ་|ཆ་ཚད་ \d+ ཧ་མ་|ལ་འཁར་ \d+ ནང་|སར་ཆ་ \d+ ཧ་མ་|སར་མ་ \d+ ཧ་མ་|ཆ་ཚད་ \d+ ནང་|ཉནམ་ \d+ ཧ་མ་|སར་ཆ་ \d+ ནང་|སར་མ་ \d+ ནང་|ཉནམ་ \d+ ནང་|ཟཝ་ \d+ ཧ་མ་|ཟཝ་ \d+ ནང་)(\z|\W|_)`),
