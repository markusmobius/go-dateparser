...
var jgo_Locale = LocaleData{
	...
	Translations: []ReplacementData{
		{regexp.MustCompile(`(\A|\W|_)ɛ gɛ mɔ (\d+) ŋgap-mbi(\z|\W|_)`), "${1}${2} week ago${3}"},
		{regexp.MustCompile(`(\A|\W|_)ɛ gɛ mɔ pɛsaŋ (\d+)(\z|\W|_)`), "${1}${2} month ago${3}"},
		{regexp.MustCompile(`(\A|\W|_)nǔu ŋgap-mbi (\d+)(\z|\W|_)`), "${1}in ${2} week${3}"},
		{regexp.MustCompile(`(\A|\W|_)ɛ gɛ mɔ (\d+) háwa(\z|\W|_)`), "${1}${2} hour ago${3}"},
		{regexp.MustCompile(`(\A|\W|_)ɛ gɛ mɔ lɛꞌ (\d+)(\z|\W|_)`), "${1}${2} day ago${3}"},
		{regexp.MustCompile(`(\A|\W|_)ɛgɛ mɔ ŋguꞌ (\d+)(\z|\W|_)`), "${1}${2} year ago${3}"},
		{regexp.MustCompile(`(\A|\W|_)nǔu (\d+) minút(\z|\W|_)`), "${1}in ${2} minute${3}"},
		{regexp.MustCompile(`(\A|\W|_)pɛsaŋ pɛnɛntúkú(\z|\W|_)`), "${1}june${2}"},
		{regexp.MustCompile(`(\A|\W|_)pɛsaŋ pɛnɛpfúꞌú(\z|\W|_)`), "${1}september${2}"},
		...
		{regexp.MustCompile(`(\A|\W|_)nǔu lɛꞌ (\d+)(\z|\W|_)`), "${1}in ${2} day${3}"},
		{regexp.MustCompile(`(\A|\W|_)pɛsaŋ ntsɔpmɔ(\z|\W|_)`), "${1}november${2}"},
		{regexp.MustCompile(`(\A|\W|_)pɛsaŋ ntsɔppá(\z|\W|_)`), "${1}december${2}"},
		{regexp.MustCompile(`(\A|\W|_)pɛsaŋ pɛnɛfɔm(\z|\W|_)`), "${1}august${2}"},
		{regexp.MustCompile(`(\A|\W|_)pɛsaŋ pɛnɛkwa(\z|\W|_)`), "${1}april${2}"},
		{regexp.MustCompile(`(\A|\W|_)pɛsaŋ saambá(\z|\W|_)`), "${1}july${2}"},
		{regexp.MustCompile(`(\A|\W|_)ŋka mbɔt nji(\z|\W|_)`), "${1}pm${2}"},
		{regexp.MustCompile(`(\A|\W|_)nduŋmbi saŋ(\z|\W|_)`), "${1}january${2}"},
		{regexp.MustCompile(`(\A|\W|_)pɛsaŋ nɛgɛm(\z|\W|_)`), "${1}october${2}"},
		{regexp.MustCompile(`(\A|\W|_)pɛsaŋ pataa(\z|\W|_)`), "${1}may${2}"},
		{regexp.MustCompile(`(\A|\W|_)pɛsaŋ pɛtát(\z|\W|_)`), "${1}march${2}"},
		...
		{regexp.MustCompile(`(\A|\W|_)pɛsaŋ pɛpá(\z|\W|_)`), "${1}february${2}"},
		{regexp.MustCompile(`(\A|\W|_)this month(\z|\W|_)`), "${1}0 month ago${2}"},
		{regexp.MustCompile(`(\A|\W|_)ápta mɔndi(\z|\W|_)`), "${1}tuesday${2}"},
