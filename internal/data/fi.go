...
var fi_Locale = merge(nil, LocaleData{
	...
	Simplifications: []ReplacementData{
		{regexp.MustCompile(`(?i)(\A|\W|_)(\d+) (sekunnin|sekuntin|minuutin|tunnin|paivan|viikon|kuukauden|vuoden) (paasta|kuluttua)(\z|\W|_)`), "${1}${4} ${2} ${3}${5}"},
	},
	...
	RxCombined:      regexp.MustCompile(`(?i)(\A|\W|_)(\d+ kuukauden paasta|\d+ kuukautta sitten|\d+ minuuttia sitten|\d+ kuukausi sitten|\d+ minuutin paasta|\d+ minuutti sitten|\d+ sekunnin paasta|\d+ sekuntia sitten|\d+ sekunti sitten|\d+ viikkoa sitten|\d+ paivaa sitten|\d+ paivan paasta|\d+ tunnin paasta|\d+ tuntia sitten|\d+ viikko sitten|\d+ viikon paasta|\d+ vuoden paasta|\d+ vuotta sitten|\d+ paiva sitten|\d+ tunti sitten|\d+ vuosi sitten|\d+ min paasta|\d+ min sitten|\d+ kk paasta|\d+ kk sitten|\d+ pv paasta|\d+ pv sitten|\d+ vk paasta|\d+ vk sitten|\d+ s paasta|\d+ s sitten|\d+ t paasta|\d+ t sitten|\d+ v paasta|\d+ v sitten)(\z|\W|_)`),
