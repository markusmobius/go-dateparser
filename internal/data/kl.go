...
var kl_Locale = LocaleData{
	...
	Translations: map[*regexp.Regexp]string{
		regexp.MustCompile(`(\A|\W|_)for (\d+) ulloq unnuarlu siden(\z|\W|_)`):         "${1}$2 day ago${3}",
		regexp.MustCompile(`(\A|\W|_)for (\d+) nalunaaquttap-akunnera siden(\z|\W|_)`): "${1}$2 hour ago${3}",
		regexp.MustCompile(`(\A|\W|_)for (\d+) qaammat siden(\z|\W|_)`):                "${1}$2 month ago${3}",
		regexp.MustCompile(`(\A|\W|_)for (\d+) sekundi siden(\z|\W|_)`):                "${1}$2 second ago${3}",
		regexp.MustCompile(`(\A|\W|_)for (\d+) sapaatip-akunnera siden(\z|\W|_)`):      "${1}$2 week ago${3}",
		regexp.MustCompile(`(\A|\W|_)for (\d+) ukioq siden(\z|\W|_)`):                  "${1}$2 year ago${3}",
		...
		regexp.MustCompile(`(\A|\W|_)augustusi(\z|\W|_)`):                              "${1}august${2}",
		regexp.MustCompile(`(\A|\W|_)day(\z|\W|_)`):                                    "${1}day${2}",
		regexp.MustCompile(`(\A|\W|_)dec(\z|\W|_)`):                                    "${1}december${2}",
		regexp.MustCompile(`(\A|\W|_)decemberi(\z|\W|_)`):                              "${1}december${2}",
		regexp.MustCompile(`(\A|\W|_)feb(\z|\W|_)`):                                    "${1}february${2}",
		regexp.MustCompile(`(\A|\W|_)februari(\z|\W|_)`):                               "${1}february${2}",
		regexp.MustCompile(`(\A|\W|_)tal(\z|\W|_)`):                                    "${1}friday${2}",
		regexp.MustCompile(`(\A|\W|_)tallimanngorneq(\z|\W|_)`):                        "${1}friday${2}",
		regexp.MustCompile(`(\A|\W|_)hour(\z|\W|_)`):                                   "${1}hour${2}",
		regexp.MustCompile(`(\A|\W|_)om (\d+) ulloq unnuarlu(\z|\W|_)`):                "${1}in $2 day${3}",
		regexp.MustCompile(`(\A|\W|_)om (\d+) nalunaaquttap-akunnera(\z|\W|_)`):        "${1}in $2 hour${3}",
		regexp.MustCompile(`(\A|\W|_)om (\d+) minutsi(\z|\W|_)`):                       "${1}in $2 minute${3}",
		regexp.MustCompile(`(\A|\W|_)om (\d+) qaammat(\z|\W|_)`):                       "${1}in $2 month${3}",
		regexp.MustCompile(`(\A|\W|_)om (\d+) sekundi(\z|\W|_)`):                       "${1}in $2 second${3}",
		regexp.MustCompile(`(\A|\W|_)om (\d+) sapaatip-akunnera(\z|\W|_)`):             "${1}in $2 week${3}",
		regexp.MustCompile(`(\A|\W|_)om (\d+) ukioq(\z|\W|_)`):                         "${1}in $2 year${3}",
		...
		regexp.MustCompile(`(\A|\W|_)martsi(\z|\W|_)`):                                 "${1}march${2}",
		regexp.MustCompile(`(\A|\W|_)maj(\z|\W|_)`):                                    "${1}may${2}",
		regexp.MustCompile(`(\A|\W|_)maji(\z|\W|_)`):                                   "${1}may${2}",
		regexp.MustCompile(`(\A|\W|_)ata(\z|\W|_)`):                                    "${1}monday${2}",
		regexp.MustCompile(`(\A|\W|_)ataasinngorneq(\z|\W|_)`):                         "${1}monday${2}",
		regexp.MustCompile(`(\A|\W|_)month(\z|\W|_)`):                                  "${1}month${2}",
		regexp.MustCompile(`(\A|\W|_)nov(\z|\W|_)`):                                    "${1}november${2}",
		regexp.MustCompile(`(\A|\W|_)novemberi(\z|\W|_)`):                              "${1}november${2}",
		regexp.MustCompile(`(\A|\W|_)okt(\z|\W|_)`):                                    "${1}october${2}",
		regexp.MustCompile(`(\A|\W|_)oktoberi(\z|\W|_)`):                               "${1}october${2}",
		regexp.MustCompile(`(\A|\W|_)pm(\z|\W|_)`):                                     "${1}pm${2}",
		regexp.MustCompile(`(\A|\W|_)arf(\z|\W|_)`):                                    "${1}saturday${2}",
		regexp.MustCompile(`(\A|\W|_)arfininngorneq(\z|\W|_)`):                         "${1}saturday${2}",
		regexp.MustCompile(`(\A|\W|_)second(\z|\W|_)`):                                 "${1}second${2}",
		regexp.MustCompile(`(\A|\W|_)sep(\z|\W|_)`):                                    "${1}september${2}",
		regexp.MustCompile(`(\A|\W|_)septemberi(\z|\W|_)`):                             "${1}september${2}",
		regexp.MustCompile(`(\A|\W|_)sab(\z|\W|_)`):                                    "${1}sunday${2}",
		regexp.MustCompile(`(\A|\W|_)sabaat(\z|\W|_)`):                                 "${1}sunday${2}",
		regexp.MustCompile(`(\A|\W|_)sis(\z|\W|_)`):                                    "${1}thursday${2}",
		regexp.MustCompile(`(\A|\W|_)sisamanngorneq(\z|\W|_)`):                         "${1}thursday${2}",
		regexp.MustCompile(`(\A|\W|_)marlunngorneq(\z|\W|_)`):                          "${1}tuesday${2}",
		regexp.MustCompile(`(\A|\W|_)pin(\z|\W|_)`):                                    "${1}wednesday${2}",
		regexp.MustCompile(`(\A|\W|_)pingasunngorneq(\z|\W|_)`):                        "${1}wednesday${2}",
