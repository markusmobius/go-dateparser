...
var br_Locale = merge(nil, LocaleData{
	...
	RxCombined:      regexp.MustCompile(`(?i)(\A|\W|_)(a-benn \d+ eilenn|a-benn \d+ sizhun|a-benn \d+ bloaz|a-benn \d+ munut|a-benn \d+ vloaz|a-benn \d+ deiz|a-benn \d+ eur|a-benn \d+ min|a-benn \d+ miz|\d+ eilenn zo|\d+ sizhun zo|a-benn \d+ bl|\d+ bloaz zo|\d+ munut zo|\d+ vloaz zo|a-benn \d+ d|a-benn \d+ e|a-benn \d+ s|\d+ deiz zo|\d+ eur zo|\d+ min zo|\d+ miz zo|\d+ bl zo|\d+ d zo|\d+ e zo|\d+ s zo)(\z|\W|_)`),
	...
	RxKnownWords:    regexp.MustCompile(`(?i)^(.*?(?:\A|\W|_|\d))(ar sizhun diaraok|ar sizhun a zeu|ar bloaz a zeu|ar miz diaraok|ar sizhun-man|ar miz a zeu|ar bl a zeu|this minute|ar miz-man|warc'hoazh|c'hwevrer|this hour|gwengolo|merc'her|mezheven|hevlene|warlene|breman|eilenn|genver|gouere|gwener|meurzh|sadorn|sizhun|bloaz|c'hwe|dec'h|ebrel|hiziv|kerzu|munut|brem|deiz|eost|goue|gwen|here|meur|mezh|yaou|ebr|eur|gen|gmt|gwe|ker|kzu|lun|mae|mer|meu|min|miz|sad|sul|utc|\+|\.|\[|\]|\||am|bl|du|gm|pm| |'|,|-|/|:|;|@|d|e|s|z)((?:\z|\W|_|\d).*)$`),
})
