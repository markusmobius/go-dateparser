...
func init() {
	sq_Locale = merge(nil, LocaleData{
		...
		ExactCombinedMatcher: matchExact6446b4bfd6e02cf3a82cfacf40d9d0a1640fd9cbf08d697d103f843b2a2441b3,
		KnownWords:           []string{"muajin e ardhshem", "javen e ardhshme", "vitin e ardhshem", "muajin e kaluar", "javen e kaluar", "vitin e kaluar", "e paradites", "kete minute", "e pasdites", "e merkure", "kete jave", "kete muaj", "e premte", "e shtune", "kete ore", "kete vit", "paradite", "dhjetor", "e enjte", "e marte", "pasdite", "qershor", "sekonde", "shtator", "e diel", "e hene", "korrik", "minute", "nentor", "shkurt", "sivjet", "gusht", "janar", "neser", "prill", "tetor", "dite", "gush", "jave", "korr", "mars", "muaj", "tani", "vjet", "dhj", "die", "dje", "enj", "gmt", "gsh", "hen", "jan", "kor", "maj", "mar", "mer", "min", "mot", "nen", "ore", "pre", "pri", "qer", "sek", "shk", "sht", "sot", "tet", "utc", "vit", "am", "md", "pd", "pm", " ", "'", "+", ",", "-", ".", "/", ":", ";", "@", "[", "]", "z", "|"},
	})
