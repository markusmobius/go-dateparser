...
var af_Locale = merge(nil, LocaleData{
	...
	RxCombined:      regexp.MustCompile(`(?i)(\A|\W|_)(\d+ sekondes gelede|\d+ sekonde gelede|\d+ maande gelede|\d+ minute gelede|\d+ minuut gelede|\d+ maand gelede|oor \d+ sekondes|\d+ jaar gelede|\d+ week gelede|\d+ weke gelede|oor \d+ sekonde|\d+ dae gelede|\d+ dag gelede|\d+ min gelede|\d+ sek gelede|\d+ uur gelede|oor \d+ minuut|\d+ md gelede|\d+ w gelede|oor \d+ jaar|oor \d+ week|oor \d+ weke|oor \d+ dae|oor \d+ dag|oor \d+ min|oor \d+ sek|oor \d+ uur|oor \d+ md|oor \d+ w)(\z|\W|_)`),
