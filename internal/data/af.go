...
func init() {
	af_Locale = merge(nil, LocaleData{
		...
		RelativeType: map[string]string{
			...
			"hierdie week":   "0 week ago",
			"vandeesmaand":   "0 month ago",
			"verlede jaar":   "1 year ago",
			"verlede week":   "1 week ago",
			"hierdie uur":    "0 hour ago",
			"vandeesweek":    "0 week ago",
			"volgende md":    "in 1 month",
			"hierdie md":     "0 month ago",
			"verlede md":     "1 month ago",
			"volgende j":     "in 1 year",
			"volgende w":     "in 1 week",
			"hierdie j":      "0 year ago",
			"hierdie w":      "0 week ago",
			"verlede j":      "1 year ago",
			"verlede w":      "1 week ago",
			"gister":         "1 day ago",
			"vandag":         "0 day ago",
			"more":           "in 1 day",
			"nou":            "0 second ago",
		...
		RelativeTypeRegexes: []ReplacementData{
			...
			{regexp.MustCompile(`(?i)oor (\d+[.,]?\d*) maande`), "in $1 month"},
			{regexp.MustCompile(`(?i)oor (\d+[.,]?\d*) minute`), "in $1 minute"},
			{regexp.MustCompile(`(?i)oor (\d+[.,]?\d*) minuut`), "in $1 minute"},
			{regexp.MustCompile(`(?i)(\d+[.,]?\d*) md gelede`), "$1 month ago"},
			{regexp.MustCompile(`(?i)oor (\d+[.,]?\d*) maand`), "in $1 month"},
			{regexp.MustCompile(`(?i)(\d+[.,]?\d*) j gelede`), "$1 year ago"},
			{regexp.MustCompile(`(?i)(\d+[.,]?\d*) s gelede`), "$1 second ago"},
			{regexp.MustCompile(`(?i)(\d+[.,]?\d*) u gelede`), "$1 hour ago"},
			...
			{regexp.MustCompile(`(?i)oor (\d+[.,]?\d*) j`), "in $1 year"},
			{regexp.MustCompile(`(?i)oor (\d+[.,]?\d*) s`), "in $1 second"},
			{regexp.MustCompile(`(?i)oor (\d+[.,]?\d*) u`), "in $1 hour"},
			{regexp.MustCompile(`(?i)oor (\d+[.,]?\d*) w`), "in $1 week"},
		},
		RxCombined:           regexp.MustCompile(`(?i)(\A|[^\pL\pM\d]|_)(\d+[.,]?\d* sekondes gelede|\d+[.,]?\d* sekonde gelede|\d+[.,]?\d* maande gelede|\d+[.,]?\d* minute gelede|\d+[.,]?\d* minuut gelede|\d+[.,]?\d* maand gelede|oor \d+[.,]?\d* sekondes|\d+[.,]?\d* jaar gelede|\d+[.,]?\d* week gelede|\d+[.,]?\d* weke gelede|oor \d+[.,]?\d* sekonde|\d+[.,]?\d* dae gelede|\d+[.,]?\d* dag gelede|\d+[.,]?\d* min gelede|\d+[.,]?\d* sek gelede|\d+[.,]?\d* uur gelede|oor \d+[.,]?\d* maande|oor \d+[.,]?\d* minute|oor \d+[.,]?\d* minuut|\d+[.,]?\d* md gelede|oor \d+[.,]?\d* maand|\d+[.,]?\d* j gelede|\d+[.,]?\d* s gelede|\d+[.,]?\d* u gelede|\d+[.,]?\d* w gelede|oor \d+[.,]?\d* jaar|oor \d+[.,]?\d* week|oor \d+[.,]?\d* weke|oor \d+[.,]?\d* dae|oor \d+[.,]?\d* dag|oor \d+[.,]?\d* min|oor \d+[.,]?\d* sek|oor \d+[.,]?\d* uur|oor \d+[.,]?\d* md|oor \d+[.,]?\d* j|oor \d+[.,]?\d* s|oor \d+[.,]?\d* u|oor \d+[.,]?\d* w)(\z|[^\pL\pM\d]|_)`),
		RxExactCombined:      regexp.MustCompile(`(?i)^(\d+[.,]?\d* sekondes gelede|\d+[.,]?\d* sekonde gelede|\d+[.,]?\d* maande gelede|\d+[.,]?\d* minute gelede|\d+[.,]?\d* minuut gelede|\d+[.,]?\d* maand gelede|oor \d+[.,]?\d* sekondes|\d+[.,]?\d* jaar gelede|\d+[.,]?\d* week gelede|\d+[.,]?\d* weke gelede|oor \d+[.,]?\d* sekonde|\d+[.,]?\d* dae gelede|\d+[.,]?\d* dag gelede|\d+[.,]?\d* min gelede|\d+[.,]?\d* sek gelede|\d+[.,]?\d* uur gelede|oor \d+[.,]?\d* maande|oor \d+[.,]?\d* minute|oor \d+[.,]?\d* minuut|\d+[.,]?\d* md gelede|oor \d+[.,]?\d* maand|\d+[.,]?\d* j gelede|\d+[.,]?\d* s gelede|\d+[.,]?\d* u gelede|\d+[.,]?\d* w gelede|oor \d+[.,]?\d* jaar|oor \d+[.,]?\d* week|oor \d+[.,]?\d* weke|oor \d+[.,]?\d* dae|oor \d+[.,]?\d* dag|oor \d+[.,]?\d* min|oor \d+[.,]?\d* sek|oor \d+[.,]?\d* uur|oor \d+[.,]?\d* md|oor \d+[.,]?\d* j|oor \d+[.,]?\d* s|oor \d+[.,]?\d* u|oor \d+[.,]?\d* w)$`),
		ExactCombinedMatcher: matchExact31f110b7ef5ea03bfe6e9aaa68161ccda2e7f4455a654b239739228bd600ab8c,
		KnownWords:           []string{"hierdie minuut", "volgende maand", "verlede maand", "volgende jaar", "volgende week", "hierdie jaar", "hierdie week", "vandeesmaand", "verlede jaar", "verlede week", "hierdie uur", "vandeesweek", "volgende md", "hierdie md", "verlede md", "volgende j", "volgende w", "donderdag", "februarie", "hierdie j", "hierdie w", "september", "verlede j", "verlede w", "augustus", "desember", "januarie", "november", "saterdag", "woensdag", "dinsdag", "maandag", "oktober", "sekonde", "gister", "minuut", "sondag", "vandag", "vrydag", "april", "julie", "junie", "maand", "maart", "jaar", "more", "week", "apr", "aug", "dag", "des", "feb", "gmt", "jan", "jul", "jun", "mei", "min", "mrt", "nou", "nov", "okt", "sek", "sep", "utc", "uur", "am", "di", "do", "ma", "md", "nm", "pm", "sa", "so", "vm", "vr", "wk", "wo", " ", "'", "+", ",", "-", ".", "/", ":", ";", "@", "[", "]", "d", "j", "m", "s", "u", "z", "|"},
	})
