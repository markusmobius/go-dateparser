...
var gu_Locale = merge(nil, LocaleData{
	...
	RxCombined:      regexp.MustCompile(`(?i)(\A|\W|_)(\d+ અઠવાડિયા પહલા|\d+ અઠવાડિયામા|\d+ મહિના પહલા|\d+ મિનિટ પહલા|\d+ કલાક પહલા|\d+ દિવસ પહલા|\d+ વરષ પહલા|\d+ સકડ પહલા|\d+ અઠ પહલા|\d+ મહિનામા|\d+ મિનિટમા|\d+ કલાકમા|\d+ દિવસમા|\d+ અઠ મા|\d+ વરષમા|\d+ સકડમા)(\z|\W|_)`),
