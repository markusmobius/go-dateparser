...
var he_Locale = merge(nil, LocaleData{
	Name:      "he",
	DateOrder: "DMY",
	Charset:   []rune("+,-./;@[]cgtuz|אבגדהוזחטיךכלםמןנסעפץצקרשת׳״"),
