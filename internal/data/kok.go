...
var kok_Locale = LocaleData{
	...
	Translations: map[*regexp.Regexp]string{
		...
		regexp.MustCompile(`(\A|\W|_)ओगस्ट(\z|\W|_)`):       "${1}august${2}",
		...
		regexp.MustCompile(`(\A|\W|_)ओक्टोबर(\z|\W|_)`):     "${1}october${2}",
		regexp.MustCompile(`(\A|\W|_)मनं(\z|\W|_)`):         "${1}pm${2}",
		...
		regexp.MustCompile(`(\A|\W|_)सेप्टेंबर(\z|\W|_)`):   "${1}september${2}",
		regexp.MustCompile(`(\A|\W|_)आदित्यवार(\z|\W|_)`):   "${1}sunday${2}",
		...
		regexp.MustCompile(`(\A|\W|_)मंगळार(\z|\W|_)`):      "${1}tuesday${2}",
