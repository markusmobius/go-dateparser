...
var kok_Locale = LocaleData{
	...
	Translations: []ReplacementData{
		...
		{regexp.MustCompile(`(\A|\W|_)आदितयवार(\z|\W|_)`), "${1}sunday${2}"},
		...
		{regexp.MustCompile(`(\A|\W|_)ओकटोबर(\z|\W|_)`), "${1}october${2}"},
		...
		{regexp.MustCompile(`(\A|\W|_)मगळार(\z|\W|_)`), "${1}tuesday${2}"},
		...
		{regexp.MustCompile(`(\A|\W|_)ओगसट(\z|\W|_)`), "${1}august${2}"},
		...
		{regexp.MustCompile(`(\A|\W|_)मन(\z|\W|_)`), "${1}pm${2}"},
