...
func init() {
	fa_Locale = merge(nil, LocaleData{
		...
		RelativeTypeRegexes: []ReplacementData{
			...
			{regexp.MustCompile(`(?i)(\d+[.,]?\d*) روز دیگر`), "in $1 day"},
		...
		RxCombined:           regexp.MustCompile(`(?i)(\A|[^\pL\pM\d]|_)(\d+[.,]?\d* ثانیه بعد|\d+[.,]?\d* ثانیه پیش|\d+[.,]?\d* دقیقه بعد|\d+[.,]?\d* دقیقه پیش|\d+[.,]?\d* روز دیگر|\d+[.,]?\d* ساعت بعد|\d+[.,]?\d* ساعت پیش|\d+[.,]?\d* هفته بعد|\d+[.,]?\d* هفته پیش|\d+[.,]?\d* روز بعد|\d+[.,]?\d* روز پیش|\d+[.,]?\d* سال بعد|\d+[.,]?\d* سال پیش|\d+[.,]?\d* ماه بعد|\d+[.,]?\d* ماه پیش)(\z|[^\pL\pM\d]|_)`),
		RxExactCombined:      regexp.MustCompile(`(?i)^(\d+[.,]?\d* ثانیه بعد|\d+[.,]?\d* ثانیه پیش|\d+[.,]?\d* دقیقه بعد|\d+[.,]?\d* دقیقه پیش|\d+[.,]?\d* روز دیگر|\d+[.,]?\d* ساعت بعد|\d+[.,]?\d* ساعت پیش|\d+[.,]?\d* هفته بعد|\d+[.,]?\d* هفته پیش|\d+[.,]?\d* روز بعد|\d+[.,]?\d* روز پیش|\d+[.,]?\d* سال بعد|\d+[.,]?\d* سال پیش|\d+[.,]?\d* ماه بعد|\d+[.,]?\d* ماه پیش)$`),
		ExactCombinedMatcher: matchExactcdc752fc60eadce3767ffcdcff13eda3f84e17bc31cd58d47219a63eba4dcba6,
