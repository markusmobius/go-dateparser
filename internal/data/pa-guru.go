...
var pa_Guru_Locale = merge(nil, LocaleData{
	...
	RxCombined:      regexp.MustCompile(`(?i)(\A|\W|_)(\d+ ਮਹੀਨਾ ਪਹਿਲਾ|\d+ ਮਹੀਨ ਪਹਿਲਾ|\d+ ਮਹੀਨਿਆ ਵਿਚ|\d+ ਸਕਿਟ ਪਹਿਲਾ|\d+ ਹਫਤਾ ਪਹਿਲਾ|\d+ ਘਟਾ ਪਹਿਲਾ|\d+ ਦਿਨ ਪਹਿਲਾ|\d+ ਮਿਟ ਪਹਿਲਾ|\d+ ਸਕਿਟਾ ਵਿਚ|\d+ ਸਾਲ ਪਹਿਲਾ|\d+ ਹਫਤ ਪਹਿਲਾ|\d+ ਹਫਤਿਆ ਵਿਚ|\d+ ਘਟ ਪਹਿਲਾ|\d+ ਘਟਿਆ ਵਿਚ|\d+ ਦਿਨਾ ਵਿਚ|\d+ ਮਹੀਨ ਵਿਚ|\d+ ਮਿਟਾ ਵਿਚ|\d+ ਸਕਿਟ ਵਿਚ|\d+ ਸਾਲਾ ਵਿਚ|\d+ ਦਿਨ ਵਿਚ|\d+ ਮਿਟ ਵਿਚ|\d+ ਸਾਲ ਵਿਚ|\d+ ਹਫਤ ਵਿਚ|\d+ ਘਟ ਵਿਚ)(\z|\W|_)`),
	...
	RxKnownWords:    regexp.MustCompile(`(?i)^(.*?(?:\A|\W|_|\d))(ਪਿਛਲਾ ਮਹੀਨਾ|ਅਗਲਾ ਮਹੀਨਾ|ਪਿਛਲਾ ਹਫਤਾ|ਅਗਲਾ ਹਫਤਾ|ਪਿਛਲਾ ਸਾਲ|ਬੀਤਿਆ ਕਲਹ|ਅਗਲਾ ਸਾਲ|ਇਹ ਮਹੀਨਾ|ਸਨਿਚਰਵਾਰ|ਇਹ ਹਫਤਾ|ਇਸ ਮਿਟ|ਇਹ ਸਾਲ|ਮਗਲਵਾਰ|ਵੀਰਵਾਰ|ਸਕਰਵਾਰ|ਅਕਤਬਰ|ਇਸ ਘਟ|ਐਤਵਾਰ|ਜਨਵਰੀ|ਫਰਵਰੀ|ਬਧਵਾਰ|ਮਹੀਨਾ|ਸਨਿਚਰ|ਸਮਵਾਰ|ਅਗਸਤ|ਅਪਰਲ|ਜਲਾਈ|ਦਸਬਰ|ਨਵਬਰ|ਮਾਰਚ|ਸਕਿਟ|ਸਤਬਰ|ਹਫਤਾ|gmt|utc|ਅਕਤ|ਅਪਰ|ਘਟਾ|ਜਲਾ|ਦਿਨ|ਬਾਦ|ਭਲਕ|ਮਗਲ|ਮਿਟ|ਵੀਰ|ਸਕਰ|ਸਾਲ|\+|\.|\[|\]|\||am|pm|ਅਗ|ਅਜ|ਐਤ|ਜਨ|ਦਸ|ਨਵ|ਪਦ|ਫਰ|ਬਧ|ਮਈ|ਸਤ|ਸਮ|ਹਣ| |'|,|-|/|:|;|@|z|ਘ)((?:\z|\W|_|\d).*)$`),
})
