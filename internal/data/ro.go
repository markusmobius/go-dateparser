...
var ro_Locale = merge(nil, LocaleData{
	...
	RxKnownWords:    regexp.MustCompile(`(?i)^(.*?(?:\A|\W|_|\d))(saptamana viitoare|saptamana aceasta|saptamana trecuta|minutul acesta|luna viitoare|luna aceasta|luna trecuta|anul acesta|anul trecut|anul viitor|ora aceasta|septembrie|decembrie|februarie|noiembrie|octombrie|saptamana|saptamani|duminica|ianuarie|miercuri|aprilie|in urma|sambata|secunda|secunde|august|martie|minute|vineri|iulie|iunie|maine|marti|minut|noiem|acum|febr|ieri|luna|luni|mart|sapt|sept|zile|ani|apr|aug|azi|dec|dum|feb|gmt|ian|iul|iun|joi|lun|mai|mar|mie|min|nov|oct|ora|ore|sam|sec|sep|utc|vin|\+|\.|\[|\]|\||am|an|de|in|la|mi|pm|zi| |'|,|-|/|:|;|@|h|m|s|z)((?:\z|\W|_|\d).*)$`),
})
