...
var ru_Locale = merge(nil, LocaleData{
	...
	KnownWords:      []string{"на следующеи неделе", "в следующем месяце", "на прошлои неделе", "в прошлом месяце", "в следующем году", "в прошлом году", "на этои неделе", "в этом месяце", "в эту минуту", "в этом году", "в этом часе", "воскресение", "воскресенье", "понедельник", "послезавтра", "в течение", "позавчера", "примерно", "сентябрь", "сентября", "августа", "вторник", "декабрь", "декабря", "месяцев", "октябрь", "октября", "пятница", "пятницу", "сегодня", "секунда", "секунду", "секунды", "суббота", "субботу", "февраль", "февраля", "четверг", "август", "апрель", "апреля", "завтра", "месяца", "минута", "минуту", "минуты", "недели", "недель", "неделю", "неделя", "ноябрь", "ноября", "сеичас", "секунд", "спустя", "январь", "января", "вчера", "марта", "месяц", "минут", "назад", "около", "среда", "среду", "сутки", "суток", "часов", "через", "года", "день", "днеи", "июль", "июля", "июнь", "июня", "март", "нояб", "сент", "февр", "часа", "gmt", "utc", "авг", "апр", "вск", "втр", "год", "дек", "дня", "июл", "июн", "лет", "маи", "мар", "мая", "мес", "мин", "нед", "ноя", "окт", "пнд", "птн", "сбт", "сек", "сен", "срд", "фев", "час", "чтв", "янв", "am", "pm", "во", "вс", "вт", "дн", "дп", "пн", "пп", "пт", "сб", "ср", "чт", " ", "'", "+", ",", "-", ".", "/", ":", ";", "@", "[", "]", "z", "|", "в", "г", "и", "с", "ч"},
})
