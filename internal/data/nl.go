...
var nl_Locale = merge(nil, LocaleData{
	...
	RxKnownWords:    regexp.MustCompile(`(?i)^(.*?(?:\A|\W|_|\d))(binnen een minuut|binnen een uur|volgende maand|volgende week|volgend jaar|vorige maand|eergisteren|vorige jaar|vorige week|deze maand|overmorgen|vorig jaar|deze week|donderdag|september|augustus|december|dit jaar|februari|gisteren|november|seconden|woensdag|zaterdag|dinsdag|geleden|januari|maandag|maanden|minuten|oktober|seconde|vandaag|vrijdag|minuut|morgen|zondag|april|dagen|maand|maart|weken|jaar|juli|juni|week|apr|aug|dag|dec|feb|gmt|jan|jul|jun|mei|min|mnd|mrt|nov|okt|sec|sep|utc|uur|\+|\.|\[|\]|\||am|di|do|in|jr|ma|nu|om|pm|vr|wk|wo|za|zo| |'|,|-|/|:|;|@|s|z)((?:\z|\W|_|\d).*)$`),
})
