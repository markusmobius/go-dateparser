...
func init() {
	tr_Locale = merge(nil, LocaleData{
		...
		ExactCombinedMatcher: matchExact6d4ad3da050769051ced20d2cc2b77901a440474552d8fec2b09875de8177863,
		KnownWords:           []string{"onumuzdeki hafta", "onumuzdeki gun", "onumuzdeki yıl", "gelecek hafta", "onumuzdeki ay", "gecen hafta", "gelecek yıl", "gelecek ay", "gelecek hf", "icerisinde", "bu dakika", "cumartesi", "gecen gun", "gecen yıl", "pazartesi", "bu hafta", "carsamba", "gecen ay", "gecen hf", "persembe", "yaklasık", "agustos", "bu saat", "haftaya", "haziran", "aralık", "bu yıl", "dakika", "icinde", "saniye", "temmuz", "bu ay", "bu hf", "bugun", "eylul", "hafta", "kasım", "mayıs", "nisan", "pazar", "simdi", "sonra", "subat", "yarın", "cuma", "ekim", "mart", "ocak", "once", "saat", "salı", "sene", "agu", "ara", "car", "cmt", "crs", "cum", "dun", "eki", "eyl", "gmt", "gun", "haz", "kas", "mar", "may", "nis", "oca", "paz", "per", "prs", "pzt", "sal", "sub", "tem", "utc", "yıl", "ag", "am", "ar", "ay", "dk", "ek", "ey", "ha", "hf", "ka", "ni", "oc", "oo", "os", "pm", "sa", "sn", "su", "te", "ve", " ", "'", "+", ",", "-", ".", "/", ":", ";", "@", "[", "]", "z", "|"},
	})
