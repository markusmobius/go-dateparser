...
var yav_Locale = LocaleData{
	...
	Translations: []ReplacementData{
		...
		{regexp.MustCompile(`(\A|\W|_)siɛyɛ, oóli ú kándíɛ(\z|\W|_)`), "${1}february${2}"},
		...
		{regexp.MustCompile(`(\A|\W|_)kisɛndɛ(\z|\W|_)`), "${1}pm${2}"},
		{regexp.MustCompile(`(\A|\W|_)kiɛmɛɛm(\z|\W|_)`), "${1}am${2}"},
		{regexp.MustCompile(`(\A|\W|_)pilɔndɔ(\z|\W|_)`), "${1}december${2}"},
		...
		{regexp.MustCompile(`(\A|\W|_)sɔndiɛ(\z|\W|_)`), "${1}sunday${2}"},
		{regexp.MustCompile(`(\A|\W|_)efute(\z|\W|_)`), "${1}july${2}"},
		{regexp.MustCompile(`(\A|\W|_)puɔsɛ(\z|\W|_)`), "${1}day${2}"},
