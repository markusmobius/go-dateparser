...
var ur_Locale = merge(nil, LocaleData{
	...
	RxCombined:      regexp.MustCompile(`(?i)(\A|\W|_)(\d+ سیکنڈ پہلے|\d+ مہینہ پہلے|\d+ مہینے پہلے|\d+ گھنٹوں میں|\d+ گھنٹہ پہلے|\d+ گھنٹے پہلے|\d+ دنوں پہلے|\d+ سیکنڈ میں|\d+ مہینہ میں|\d+ مہینے میں|\d+ گھنٹہ میں|\d+ گھنٹے میں|\d+ ہفتہ پہلے|\d+ ہفتے پہلے|\d+ دنوں میں|\d+ سال پہلے|\d+ ماہ پہلے|\d+ منٹ پہلے|\d+ ہفتہ میں|\d+ ہفتے میں|\d+ دن پہلے|\d+ سال میں|\d+ ماہ قبل|\d+ ماہ میں|\d+ منٹ میں|\d+ دن میں)(\z|\W|_)`),
...
var ur_IN_Locale = merge(&ur_Locale, LocaleData{
	...
	RxCombined:      regexp.MustCompile(`(?i)(\A|\W|_)(\d+ سالوں پہلے|\d+ سالوں میں|\d+ سیکنڈ قبل|\d+ گھنٹہ قبل|\d+ گھنٹے قبل|\d+ ہفتوں میں|\d+ ہفتہ قبل|\d+ ہفتے قبل|\d+ منٹ قبل|\d+ دن قبل)(\z|\W|_)`),
	...
	RxKnownWords:    regexp.MustCompile(`(?i)^(.*?(?:\A|\W|_|\d))(گزشتہ ہفتہ|گزشتہ ماہ|اگلے ماہ|اس ماہ|gmt|utc|پیر|\+|\.|am|pm| |-|/|:|z)((?:\z|\W|_|\d).*)$`),
})
