...
func init() {
	ur_Locale = merge(nil, LocaleData{
		...
		RelativeType: map[string]string{
			...
			"اگلا مہینہ":  "in 1 month",
			"اگلے مہینہ":  "in 1 month",
			"پچھلے ہفتہ":  "1 week ago",
			"گزشتہ ہفتے":  "1 week ago",
			"اگلے ہفتہ":   "in 1 week",
			"اگلے ہفتے":   "in 1 week",
		...
		ExactCombinedMatcher: matchExactf53370ff44546c3607918672985a4deed4bb5c81203916ef7ba9182363064c8c,
		KnownWords:           []string{"پچھلے مہینہ", "اگلا مہینہ", "اگلے مہینہ", "پچھلے ہفتہ", "گزشتہ ہفتے", "اگلے ہفتہ", "اگلے ہفتے", "گزشتہ سال", "گزشتہ ماہ", "اس مہینہ", "اس گھنٹے", "ايندہ کل", "اگلے سال", "اگلے ماہ", "گزشتہ کل", "اس ہفتہ", "اس سال", "اس ماہ", "اس منٹ", "اکتوبر", "جمعرات", "جولايی", "سوموار", "اتوار", "اپریل", "جنوری", "دسمبر", "ستمبر", "سیکنڈ", "فروری", "مہینہ", "نومبر", "گھنٹہ", "گھنٹے", "اگست", "جمعہ", "مارچ", "منگل", "ہفتہ", "gmt", "utc", "بدھ", "جون", "سال", "ماہ", "منٹ", "ميی", "پیر", "am", "pm", "اب", "اج", "دن", " ", "'", "+", ",", "-", ".", "/", ":", ";", "@", "[", "]", "z", "|"},
	})
	...
	ur_IN_Locale = merge(&ur_Locale, LocaleData{
		...
		ExactCombinedMatcher: matchExactdf8a639dd5eea896286f66d9ee8bf47f3226ebecc08c52ddf6a622f04f2077a1,
		KnownWords:           []string{"پچھلے مہینہ", "اگلا مہینہ", "اگلے مہینہ", "پچھلے ہفتہ", "گزشتہ ہفتہ", "گزشتہ ہفتے", "اگلے ہفتہ", "اگلے ہفتے", "گزشتہ سال", "گزشتہ ماہ", "اس مہینہ", "اس گھنٹے", "ايندہ کل", "اگلے سال", "اگلے ماہ", "گزشتہ کل", "اس ہفتہ", "اس سال", "اس ماہ", "اس منٹ", "اکتوبر", "جمعرات", "جولايی", "سوموار", "اتوار", "اپریل", "جنوری", "دسمبر", "ستمبر", "سیکنڈ", "فروری", "مہینہ", "نومبر", "گھنٹہ", "گھنٹے", "اگست", "جمعہ", "مارچ", "منگل", "ہفتہ", "gmt", "utc", "بدھ", "جون", "سال", "ماہ", "منٹ", "ميی", "پیر", "am", "pm", "اب", "اج", "دن", " ", "'", "+", ",", "-", ".", "/", ":", ";", "@", "[", "]", "z", "|"},
	})
}
