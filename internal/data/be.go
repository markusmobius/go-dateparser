...
func init() {
	be_Locale = merge(nil, LocaleData{
		...
		RelativeType: map[string]string{
			...
			"на гэтым тыд":       "0 week ago",
			"у наст годзе":       "in 1 year",
			"на наст тыд":        "in 1 week",
			"у гэтым мес":        "0 month ago",
			"у мін годзе":        "1 year ago",
			"на мін тыд":         "1 week ago",
			"у наст мес":         "in 1 month",
			"пазаучора":          "2 day ago",
			"у мін мес":          "1 month ago",
			"заутра":             "in 1 day",
			"сення":              "0 day ago",
			"учора":              "1 day ago",
			"цяпер":              "0 second ago",
