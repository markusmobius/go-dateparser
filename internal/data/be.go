...
var be_Locale = merge(nil, LocaleData{
	...
	Simplifications: []ReplacementData{
		{regexp.MustCompile(`(?i)(\A|\W|_)(\d+)\s*гадзін\s(\d+)\s*хвілін(\z|\W|_)`), "${1}${2}:${3}${4}"},
		{regexp.MustCompile(`(?i)(\A|\W|_)некалькі хвілін(\z|\W|_)`), "${1}2 хвіліны${2}"},
		{regexp.MustCompile(`(?i)(\A|\W|_)некалькі секунд(\z|\W|_)`), "${1}44 секунды${2}"},
		{regexp.MustCompile(`(?i)(\A|\W|_)^гадзіна(\z|\W|_)`), "${1}1 гадзіна${2}"},
		{regexp.MustCompile(`(?i)(\A|\W|_)^секунду(\z|\W|_)`), "${1}1 секунду${2}"},
		{regexp.MustCompile(`(?i)(\A|\W|_)^хвіліну(\z|\W|_)`), "${1}1 хвіліну${2}"},
		{regexp.MustCompile(`(?i)(\A|\W|_)гадзіну(\z|\W|_)`), "${1}1 гадзіну${2}"},
	},
