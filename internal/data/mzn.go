...
var mzn_Locale = merge(nil, LocaleData{
	...
	RxCombined:      regexp.MustCompile(`(?i)(\A|\W|_)(\d+ ثانیه دله|\d+ ثانیه پیش|\d+ دقیقه دله|\d+ ساعت دله|\d+ ساعت پیش|\d+ هفته دله|\d+ هفته پیش|\d+ دقه دله|\d+ دقه پیش|\d+ روز دله|\d+ روز پیش|\d+ سال دله|\d+ سال پیش|\d+ ماه دله|\d+ ماه پیش)(\z|\W|_)`),
