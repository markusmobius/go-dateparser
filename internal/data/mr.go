...
var mr_Locale = merge(nil, LocaleData{
	...
	RxCombined:      regexp.MustCompile(`(?i)(\A|\W|_)(\d+ आठवडयापरवी|\d+ महिनयापरवी|\d+ मिनिटापरवी|\d+ आठवडयामधय|\d+ दिवसापरवी|\d+ महिनयामधय|\d+ मिनि परवी|\d+ मिनिटामधय|\d+ तासापरवी|\d+ दिवसामधय|\d+ मिनि मधय|\d+ वरषापरवी|\d+ सकदापरवी|\d+ तासामधय|\d+ वरषामधय|\d+ सकदामधय|\d+ स परवी|\d+ स मधय)(\z|\W|_)`),
	...
	RxKnownWords:    regexp.MustCompile(`(?i)^(.*?(?:\A|\W|_|\d))(मागील आठवडा|मागील महिना|पढील आठवडा|पढील महिना|या मिनिटात|मागील वरष|पढील वरष|हा आठवडा|हा महिना|जानवारी|फबरवारी|ऑकटोबर|नोवहबर|मगळवार|रविवार|शकरवार|शनिवार|सोमवार|आठवडा|एपरिल|गरवार|डिसबर|तासात|बधवार|महिना|मिनिट|सपटबर|ह वरष|आतता|उदया|एपरि|ऑकटो|ऑगसट|दिवस|नोवह|मारच|gmt|utc|काल|जान|डिस|तास|फबर|मगळ|रवि|वरष|शकर|शनि|सकद|सपट|सोम|\+|\.|\[|\]|\||am|pm|आज|ऑग|गर|जन|जल|बध|मउ|मप|मि| |'|,|-|/|:|;|@|z|म|स)((?:\z|\W|_|\d).*)$`),
})
