...
var ne_Locale = merge(nil, LocaleData{
	...
	RxCombined:      regexp.MustCompile(`(?i)(\A|[^\pL\pM\d]|_)(\d+ महिना पहिल|\d+ घणटा पहिल|\d+ मिनट पहिल|\d+ सकणड पहिल|\d+ हपता पहिल|\d+ दिन पहिल|\d+ महिनामा|\d+ वरष अघि|\d+ घणटामा|\d+ मिनटमा|\d+ सकणडमा|\d+ हपतामा|\d+ दिनमा|\d+ वरषमा)(\z|[^\pL\pM\d]|_)`),
	...
	RxKnownWords:    regexp.MustCompile(`(?i)^(.*?(?:\A|[^\pL\pM\d]|_|\d))(अरको महिना|यही मिनटमा|अरको वरष|आउन हपता|गत महिना|यो घडीमा|यो महिना|गत हपता|बिहिबार|मङगलबार|यो हपता|अकटोबर|अपराहन|आइतबार|गत वरष|डिसमबर|नोभमबर|परवाहन|फबरअरी|यो वरष|शकरबार|शनिबार|सपटमबर|सोमबार|अपरिल|जनवरी|बधबार|महिना|अगसट|घणटा|जलाई|बिहि|भोलि|मङगल|मारच|मिनट|सकनड|हपता|हिजो|gmt|utc|आइत|बरष|बार|वरष|शकर|शनि|सोम|\+|\.|\[|\]|\||am|pm|अब|आज|जन|बध|मई| |'|,|-|/|:|;|@|z|म)((?:\z|[^\pL\pM\d]|_|\d).*)$`),
})
