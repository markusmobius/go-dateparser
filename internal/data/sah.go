...
var sah_Locale = merge(nil, LocaleData{
	...
	RxKnownWords:    regexp.MustCompile(`(?i)^(.*?(?:\A|\W|_|\d))(ааспыт нэдиэлэ|атырдьых ыиын|кэлэр нэдиэлэ|атырдьых ыиа|балаҕан ыиын|баскыһыанньа|бэнидиэнньик|оптуорунньук|this minute|аныгыскы ыи|балаҕан ыиа|кулун тутар|бу нэдиэлэ|муус устар|this hour|ааспыт ыи|тохсунньу|алтынньы|ахсынньы|былырыын|бэс ыиын|бээтиҥсэ|сэтинньи|сөкүүндэ|ыам ыиын|билигин|бэс ыиа|бэҕэһээ|мүнүүтэ|нэдиэлэ|олунньу|от ыиын|субуота|чэппиэр|ыам ыиа|от ыиа|сарсын|сэрэдэ|бу ыи|быиыл|бүгүн|эһиил|олун|тохс|чаас|gmt|utc|алт|атр|ахс|блҕ|бэс|клн|күн|мсу|оти|сыл|сэт|ыам|\+|\.|\[|\]|\||am|pm|бн|бс|бэ|оп|сб|сэ|чп|ыи|эи|эк| |'|,|-|/|:|;|@|z)((?:\z|\W|_|\d).*)$`),
})
