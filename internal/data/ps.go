...
var ps_Locale = LocaleData{
	...
	Translations: map[*regexp.Regexp]string{
		...
		regexp.MustCompile(`(\A|\W|_)جنوري(\z|\W|_)`):       "${1}january${2}",
		...
		regexp.MustCompile(`(\A|\W|_)مۍ(\z|\W|_)`):          "${1}may${2}",
		...
		regexp.MustCompile(`(\A|\W|_)غو(\z|\W|_)`):          "${1}pm${2}",
