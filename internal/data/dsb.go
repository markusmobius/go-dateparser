...
var dsb_Locale = merge(nil, LocaleData{
	Name:      "dsb",
	DateOrder: "DMY",
	Charset:   []rune("+,-./;@[]bcdefghijklnorstuwyz|ł"),
	...
	RxKnownWords:    regexp.MustCompile(`(?i)^(.*?(?:\A|[^\pL\pM\d]|_|\d))(psiducy mjasec|psiducy tyzen|sledny mjasec|sledny tyzen|this minute|ten mjasec|wotpołdnja|dopołdnja|ponjezele|september|septembra|ten tyzen|this hour|december|decembra|februara|nowember|nowembra|awgusta|februar|januara|njezela|oktober|oktobra|sekunda|stwortk|wałtora|apryla|awgust|gozina|januar|julija|junija|letosa|minuta|mjasec|sobota|srjoda|apryl|julij|junij|merca|tyzen|witse|zinsa|znowa|cora|leto|maja|merc|mjas|petk|łoni|apr|awg|dec|feb|gmt|goz|jan|jul|jun|maj|mer|min|nje|now|now|okt|pet|pon|sek|sep|sob|srj|stw|tyz|utc|wał|zen|\+|\.|\[|\]|\||am|pm| |'|,|-|/|:|;|@|g|l|m|s|z)((?:\z|[^\pL\pM\d]|_|\d).*)$`),
})
