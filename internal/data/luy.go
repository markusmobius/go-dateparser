...
var luy_Locale = LocaleData{
	...
	Translations: map[*regexp.Regexp]string{
		...
		regexp.MustCompile(`(\A|\W|_)mgorova(\z|\W|_)`):         "${1}1 day ago${2}",
		...
		regexp.MustCompile(`(\A|\W|_)ridiku(\z|\W|_)`):          "${1}day${2}",
		...
		regexp.MustCompile(`(\A|\W|_)ij(\z|\W|_)`):              "${1}friday${2}",
		regexp.MustCompile(`(\A|\W|_)murwa wa katano(\z|\W|_)`): "${1}friday${2}",
		regexp.MustCompile(`(\A|\W|_)isaa(\z|\W|_)`):            "${1}hour${2}",
		regexp.MustCompile(`(\A|\W|_)mgamba(\z|\W|_)`):          "${1}in 1 day${2}",
		...
		regexp.MustCompile(`(\A|\W|_)j3(\z|\W|_)`):              "${1}monday${2}",
		...
		regexp.MustCompile(`(\A|\W|_)j1(\z|\W|_)`):              "${1}saturday${2}",
		...
		regexp.MustCompile(`(\A|\W|_)j2(\z|\W|_)`):              "${1}sunday${2}",
		regexp.MustCompile(`(\A|\W|_)jumapiri(\z|\W|_)`):        "${1}sunday${2}",
		regexp.MustCompile(`(\A|\W|_)al(\z|\W|_)`):              "${1}thursday${2}",
		regexp.MustCompile(`(\A|\W|_)murwa wa kanne(\z|\W|_)`):  "${1}thursday${2}",
		regexp.MustCompile(`(\A|\W|_)j4(\z|\W|_)`):              "${1}tuesday${2}",
		regexp.MustCompile(`(\A|\W|_)jumanne(\z|\W|_)`):         "${1}tuesday${2}",
		regexp.MustCompile(`(\A|\W|_)j5(\z|\W|_)`):              "${1}wednesday${2}",
		regexp.MustCompile(`(\A|\W|_)jumatano(\z|\W|_)`):        "${1}wednesday${2}",
		regexp.MustCompile(`(\A|\W|_)risiza(\z|\W|_)`):          "${1}week${2}",
		regexp.MustCompile(`(\A|\W|_)muhiga(\z|\W|_)`):          "${1}year${2}",
	},
}
