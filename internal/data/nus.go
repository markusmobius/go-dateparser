...
var nus_Locale = LocaleData{
	...
	Translations: []ReplacementData{
		...
		{regexp.MustCompile(`(\A|\W|_)tiop in diit(\z|\W|_)`), "${1}december${2}"},
		...
		{regexp.MustCompile(`(\A|\W|_)jiec lat(\z|\W|_)`), "${1}monday${2}"},
		...
		{regexp.MustCompile(`(\A|\W|_)duɔɔŋ(\z|\W|_)`), "${1}march${2}"},
		{regexp.MustCompile(`(\A|\W|_)laath(\z|\W|_)`), "${1}october${2}"},
		{regexp.MustCompile(`(\A|\W|_)thaak(\z|\W|_)`), "${1}hour${2}"},
		{regexp.MustCompile(`(\A|\W|_)thoor(\z|\W|_)`), "${1}august${2}"},
		{regexp.MustCompile(`(\A|\W|_)ŋuaan(\z|\W|_)`), "${1}thursday${2}"},
		{regexp.MustCompile(`(\A|\W|_)diɔk(\z|\W|_)`), "${1}wednesday${2}"},
		{regexp.MustCompile(`(\A|\W|_)duät(\z|\W|_)`), "${1}may${2}"},
		{regexp.MustCompile(`(\A|\W|_)duɔɔ(\z|\W|_)`), "${1}march${2}"},
		...
		{regexp.MustCompile(`(\A|\W|_)ruɔn(\z|\W|_)`), "${1}year${2}"},
