...
var lrc_Locale = LocaleData{
	...
	Translations: []ReplacementData{
		...
		{regexp.MustCompile(`(\A|\W|_)ئوکتوڤر(\z|\W|_)`), "${1}october${2}"},
		{regexp.MustCompile(`(\A|\W|_)سئپتامر(\z|\W|_)`), "${1}september${2}"},
		{regexp.MustCompile(`(\A|\W|_)جانڤیە(\z|\W|_)`), "${1}january${2}"},
		{regexp.MustCompile(`(\A|\W|_)دئسامر(\z|\W|_)`), "${1}december${2}"},
		{regexp.MustCompile(`(\A|\W|_)دیروٙز(\z|\W|_)`), "${1}1 day ago${2}"},
		{regexp.MustCompile(`(\A|\W|_)شوٙصوٙ(\z|\W|_)`), "${1}in 1 day${2}"},
		{regexp.MustCompile(`(\A|\W|_)فئڤریە(\z|\W|_)`), "${1}february${2}"},
		{regexp.MustCompile(`(\A|\W|_)نوڤامر(\z|\W|_)`), "${1}november${2}"},
		{regexp.MustCompile(`(\A|\W|_)آڤریل(\z|\W|_)`), "${1}april${2}"},
		{regexp.MustCompile(`(\A|\W|_)آگوست(\z|\W|_)`), "${1}august${2}"},
		{regexp.MustCompile(`(\A|\W|_)أمروٙ(\z|\W|_)`), "${1}0 day ago${2}"},
		{regexp.MustCompile(`(\A|\W|_)ثانیە(\z|\W|_)`), "${1}second${2}"},
		{regexp.MustCompile(`(\A|\W|_)جوٙأن(\z|\W|_)`), "${1}june${2}"},
		{regexp.MustCompile(`(\A|\W|_)جوٙلا(\z|\W|_)`), "${1}july${2}"},
		{regexp.MustCompile(`(\A|\W|_)ھأفتە(\z|\W|_)`), "${1}week${2}"},
		{regexp.MustCompile(`(\A|\W|_)روٙز(\z|\W|_)`), "${1}day${2}"},
		{regexp.MustCompile(`(\A|\W|_)ساأت(\z|\W|_)`), "${1}hour${2}"},
		...
		{regexp.MustCompile(`(\A|\W|_)ما(\z|\W|_)`), "${1}month${2}"},
	},
}
