...
var lrc_Locale = LocaleData{
	...
	Translations: []ReplacementData{
		...
		{regexp.MustCompile(`(\A|\W|_)أمرو(\z|\W|_)`), "${1}0 day ago${2}"},
		{regexp.MustCompile(`(\A|\W|_)جوأن(\z|\W|_)`), "${1}june${2}"},
		{regexp.MustCompile(`(\A|\W|_)جولا(\z|\W|_)`), "${1}july${2}"},
		{regexp.MustCompile(`(\A|\W|_)ساأت(\z|\W|_)`), "${1}hour${2}"},
		{regexp.MustCompile(`(\A|\W|_)شوصو(\z|\W|_)`), "${1}in 1 day${2}"},
