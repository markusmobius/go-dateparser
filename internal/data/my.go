...
var my_Locale = merge(nil, LocaleData{
	...
	RxCombined:      regexp.MustCompile(`(?i)(\A|\W|_)(ပြးခသည \d+ စကကန|ပြးခသည \d+ နာရ|ပြးခသည \d+ မနစ|ပြးခသည \d+ နစ|ပြးခသည \d+ ပတ|ပြးခသည \d+ ရက|\d+ စကကနအတငး|ပြးခသည \d+ လ|\d+ နာရအတငး|\d+ မနစအတငး|\d+ နစအတငး|\d+ ပတအတငး|\d+ ရကအတငး|\d+ လအတငး)(\z|\W|_)`),
	...
	RxKnownWords:    regexp.MustCompile(`(?i)^(.*?(?:\A|\W|_|\d))(ပြးခသည သတငးပတ|လာမည သတငးပတ|ယခ သတငးပတ|ကြာသပတေး|ဖေဖောဝါရ|ပြးခသညလ|အောကတဘာ|စကတငဘာ|ဇနနဝါရ|တနငဂနေ|မနကဖြန|လာမညနစ|သောကြာ|တနငလာ|ဒဇငဘာ|နဝငဘာ|ဗဒဓဟး|ယမနနစ|လာမညလ|ဤအချန|စကကန|မနေက|ယခနစ|အငဂါ|အောက|ဤမနစ|gmt|utc|စနေ|ဇလင|ညနေ|နနက|နာရ|မနစ|ယခလ|ယနေ|ဧပြ|ဩဂတ|\+|\.|\[|\]|\||am|pm|စက|ဇန|နစ|ပတ|ဖေ|မတ|မေ|ယခ|ရက| |'|,|-|/|:|;|@|z|ဇ|ဒ|န|လ|ဧ|ဩ)((?:\z|\W|_|\d).*)$`),
})
