...
func init() {
	zh_Hant_Locale = merge(nil, LocaleData{
		...
		ExactCombinedMatcher: matchExacta5c495d29970c0294223484fa56f9ca383bcacb81df2a8a9ed1757d302327bda,
	...
	zh_Hant_HK_Locale = merge(&zh_Hant_Locale, LocaleData{
		...
		RxCombined:           regexp.MustCompile(`(?i)(\d+[.,]?\d* 個月前|\d+[.,]?\d* 個月後|\d+[.,]?\d* 分鐘前|\d+[.,]?\d* 分鐘後|\d+[.,]?\d* 小時前|\d+[.,]?\d* 小時後|\d+[.,]?\d* 星期前|\d+[.,]?\d* 星期後|\d+[.,]?\d* 天前|\d+[.,]?\d* 天後|\d+[.,]?\d* 年前|\d+[.,]?\d* 年後|\d+[.,]?\d* 日前|\d+[.,]?\d* 日後|\d+[.,]?\d* 秒前|\d+[.,]?\d* 秒後|\d+[.,]?\d* 週前|\d+[.,]?\d* 週後|\d+[.,]?\d*個月前|\d+[.,]?\d*個月後|\d+[.,]?\d*小時前|\d+[.,]?\d*小時後|\d+[.,]?\d*星期前|\d+[.,]?\d*星期後|\d+[.,]?\d*分前|\d+[.,]?\d*分後|\d+[.,]?\d*年前|\d+[.,]?\d*年後|\d+[.,]?\d*日前|\d+[.,]?\d*日後|\d+[.,]?\d*秒前|\d+[.,]?\d*秒後|\d+[.,]?\d*週前|\d+[.,]?\d*週後)`),
		RxExactCombined:      regexp.MustCompile(`(?i)^(\d+[.,]?\d* 個月前|\d+[.,]?\d* 個月後|\d+[.,]?\d* 分鐘前|\d+[.,]?\d* 分鐘後|\d+[.,]?\d* 小時前|\d+[.,]?\d* 小時後|\d+[.,]?\d* 星期前|\d+[.,]?\d* 星期後|\d+[.,]?\d* 天前|\d+[.,]?\d* 天後|\d+[.,]?\d* 年前|\d+[.,]?\d* 年後|\d+[.,]?\d* 日前|\d+[.,]?\d* 日後|\d+[.,]?\d* 秒前|\d+[.,]?\d* 秒後|\d+[.,]?\d* 週前|\d+[.,]?\d* 週後|\d+[.,]?\d*個月前|\d+[.,]?\d*個月後|\d+[.,]?\d*小時前|\d+[.,]?\d*小時後|\d+[.,]?\d*星期前|\d+[.,]?\d*星期後|\d+[.,]?\d*分前|\d+[.,]?\d*分後|\d+[.,]?\d*年前|\d+[.,]?\d*年後|\d+[.,]?\d*日前|\d+[.,]?\d*日後|\d+[.,]?\d*秒前|\d+[.,]?\d*秒後|\d+[.,]?\d*週前|\d+[.,]?\d*週後)$`),
		ExactCombinedMatcher: matchExact7280f1b463d00c1e7d124d7874d0e12da511c9faca9a374573c6cea62bd50888,
