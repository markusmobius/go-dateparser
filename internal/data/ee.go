...
func init() {
	ee_Locale = merge(nil, LocaleData{
		...
		ExactCombinedMatcher: matchExact09abfa1a170c9ad2e8d9624fd20eec96bb7ec731eec6b1196d1070e4514d9724,
		KnownWords:           []string{"kɔsiɖa si gbɔ na", "kɔsiɖa si va yi", "ɣleti si gbɔ na", "ɣleti si va yi", "etsɔ si gbɔna", "etsɔ si va yi", "ƒe si gbɔ na", "adeɛmekpɔxe", "kɔsiɖa ɖeka", "this minute", "ƒe si va yi", "deasiamime", "kɔsiɖa sia", "aɖabaƒoƒo", "this hour", "ɣleti sia", "gaƒoƒowo", "anyɔnyɔ", "memleɖa", "siamlɔm", "afɔfie", "dzodze", "gaƒoƒo", "kɔsiɖa", "sekend", "tedoxe", "yawoɖa", "ƒe sia", "blaɖa", "dzome", "dzove", "dzoɖa", "ŋkeke", "ɣetrɔ", "ɣleti", "dama", "egbe", "fifi", "fiɖa", "kele", "kuɖa", "masa", "ade", "afɔ", "any", "bla", "dam", "dea", "dzd", "dzm", "dzo", "dzv", "fiɖ", "gmt", "kel", "kuɖ", "kɔs", "mas", "mem", "sia", "ted", "utc", "yaw", "ŋdi", "am", "pm", "ƒe", " ", "'", "+", ",", "-", ".", "/", ":", ";", "@", "[", "]", "z", "|"},
	})
