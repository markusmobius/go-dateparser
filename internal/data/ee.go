...
var ee_Locale = merge(nil, LocaleData{
	...
	RxCombined:      regexp.MustCompile(`(?i)(\A|\W|_)(aɖabaƒoƒo \d+ si wo va yi|aɖabaƒoƒo \d+ si va yi|gaƒoƒo \d+ si wo va yi|kɔsiɖa \d+ si wo va yi|le aɖabaƒoƒo \d+ wo me|sekend \d+ si wo va yi|le ƒe \d+ si gbɔna me|le ƒe \d+ si va yi me|ŋkeke \d+ si wo va yi|ɣleti \d+ si wo va yi|gaƒoƒo \d+ si va yi|kɔsiɖa \d+ si va yi|le aɖabaƒoƒo \d+ me|le gaƒoƒo \d+ wo me|le kɔsiɖa \d+ wo me|le sekend \d+ wo me|sekend \d+ si va yi|le ŋkeke \d+ wo me|le ɣleti \d+ wo me|ŋkeke \d+ si va yi|ƒe \d+ si va yi me|ƒe \d+ si wo va yi|ɣleti \d+ si va yi|le gaƒoƒo \d+ me|le kɔsiɖa \d+ me|le sekend \d+ me|le ŋkeke \d+ me|le ɣleti \d+ me|ƒe \d+ si va yi|le ƒe \d+ me)(\z|\W|_)`),
	...
	RxKnownWords:    regexp.MustCompile(`(?i)^(.*?(?:\A|\W|_|\d))(kɔsiɖa si gbɔ na|kɔsiɖa si va yi|ɣleti si gbɔ na|ɣleti si va yi|etsɔ si gbɔna|etsɔ si va yi|ƒe si gbɔ na|adeɛmekpɔxe|kɔsiɖa ɖeka|this minute|ƒe si va yi|deasiamime|kɔsiɖa sia|aɖabaƒoƒo|this hour|ɣleti sia|anyɔnyɔ|memleɖa|siamlɔm|afɔfie|dzodze|gaƒoƒo|kɔsiɖa|sekend|tedoxe|yawoɖa|ƒe sia|blaɖa|dzome|dzove|dzoɖa|ŋkeke|ɣetrɔ|ɣleti|dama|egbe|fifi|fiɖa|kele|kuɖa|masa|ade|afɔ|any|bla|dam|dea|dzd|dzm|dzo|dzv|fiɖ|gmt|kel|kuɖ|kɔs|mas|mem|sia|ted|utc|yaw|ŋdi|\+|\.|\[|\]|\||am|pm|ƒe| |'|,|-|/|:|;|@|z)((?:\z|\W|_|\d).*)$`),
})
