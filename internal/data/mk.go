...
func init() {
	mk_Locale = merge(nil, LocaleData{
		...
		RelativeType: map[string]string{
			...
			"минатата год":     "1 year ago",
			"оваа седмица":     "0 week ago",
			"следната год":     "in 1 year",
		...
		RelativeTypeRegexes: []ReplacementData{
			...
			{regexp.MustCompile(`(?i)пред (\d+[.,]?\d*) год`), "$1 year ago"},
			{regexp.MustCompile(`(?i)пред (\d+[.,]?\d*) ден`), "$1 day ago"},
			{regexp.MustCompile(`(?i)пред (\d+[.,]?\d*) мин`), "$1 minute ago"},
			{regexp.MustCompile(`(?i)пред (\d+[.,]?\d*) сек`), "$1 second ago"},
		...
		RxCombined:           regexp.MustCompile(`(?i)(\A|[^\pL\pM\d]|_)(пред \d+[.,]?\d* седмица|пред \d+[.,]?\d* седмици|пред \d+[.,]?\d* секунда|пред \d+[.,]?\d* секунди|пред \d+[.,]?\d* година|пред \d+[.,]?\d* години|пред \d+[.,]?\d* месеци|пред \d+[.,]?\d* минута|пред \d+[.,]?\d* минути|за \d+[.,]?\d* седмица|за \d+[.,]?\d* седмици|за \d+[.,]?\d* секунда|за \d+[.,]?\d* секунди|пред \d+[.,]?\d* месец|за \d+[.,]?\d* година|за \d+[.,]?\d* години|за \d+[.,]?\d* месеци|за \d+[.,]?\d* минута|за \d+[.,]?\d* минути|пред \d+[.,]?\d* дена|пред \d+[.,]?\d* часа|за \d+[.,]?\d* месец|пред \d+[.,]?\d* год|пред \d+[.,]?\d* ден|пред \d+[.,]?\d* мин|пред \d+[.,]?\d* сек|пред \d+[.,]?\d* час|за \d+[.,]?\d* дена|за \d+[.,]?\d* часа|за \d+[.,]?\d* год|за \d+[.,]?\d* ден|за \d+[.,]?\d* мин|за \d+[.,]?\d* сек|за \d+[.,]?\d* час)(\z|[^\pL\pM\d]|_)`),
		RxExactCombined:      regexp.MustCompile(`(?i)^(пред \d+[.,]?\d* седмица|пред \d+[.,]?\d* седмици|пред \d+[.,]?\d* секунда|пред \d+[.,]?\d* секунди|пред \d+[.,]?\d* година|пред \d+[.,]?\d* години|пред \d+[.,]?\d* месеци|пред \d+[.,]?\d* минута|пред \d+[.,]?\d* минути|за \d+[.,]?\d* седмица|за \d+[.,]?\d* седмици|за \d+[.,]?\d* секунда|за \d+[.,]?\d* секунди|пред \d+[.,]?\d* месец|за \d+[.,]?\d* година|за \d+[.,]?\d* години|за \d+[.,]?\d* месеци|за \d+[.,]?\d* минута|за \d+[.,]?\d* минути|пред \d+[.,]?\d* дена|пред \d+[.,]?\d* часа|за \d+[.,]?\d* месец|пред \d+[.,]?\d* год|пред \d+[.,]?\d* ден|пред \d+[.,]?\d* мин|пред \d+[.,]?\d* сек|пред \d+[.,]?\d* час|за \d+[.,]?\d* дена|за \d+[.,]?\d* часа|за \d+[.,]?\d* год|за \d+[.,]?\d* ден|за \d+[.,]?\d* мин|за \d+[.,]?\d* сек|за \d+[.,]?\d* час)$`),
		ExactCombinedMatcher: matchExact7403956eec43746b8b877ec2798c0117baf5bfd4debef3a256c23a95188212d6,
		KnownWords:           []string{"минатата седмица", "следната седмица", "минатата година", "следната година", "минатиот месец", "следниот месец", "минатата год", "оваа седмица", "следната год", "оваа година", "оваа минута", "овој месец", "понеделник", "претпладне", "септември", "декември", "догодина", "оваа год", "октомври", "попладне", "февруари", "четврток", "вторник", "ноември", "седмица", "секунда", "јануари", "август", "година", "минута", "недела", "претпл", "сабота", "април", "вчера", "денес", "месец", "петок", "среда", "часов", "лани", "март", "ноем", "попл", "сега", "септ", "утре", "часа", "јули", "јуни", "gmt", "utc", "авг", "апр", "вто", "год", "дек", "ден", "мар", "мај", "мес", "мин", "нед", "ное", "окт", "пет", "пон", "саб", "сед", "сек", "сеп", "сре", "фев", "час", "чет", "јан", "јул", "јун", "am", "pm", "вт", " ", "'", "+", ",", "-", ".", "/", ":", ";", "@", "[", "]", "z", "|", "ч"},
	})
}
