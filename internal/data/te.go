...
func init() {
	te_Locale = merge(nil, LocaleData{
		...
		RelativeTypeRegexes: []ReplacementData{
			...
			{regexp.MustCompile(`(?i)(\d+[.,]?\d*) సంలల`), "in $1 year"},
