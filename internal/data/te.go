...
var te_Locale = merge(nil, LocaleData{
	...
	RxCombined:      regexp.MustCompile(`(?i)(\A|\W|_)(\d+ సంవతసరం కరతం|\d+ సంవతసరల కరతం|\d+ గంటల కరతం|\d+ నమషం కరతం|\d+ నమషల కరతం|\d+ రజుల కరతం|\d+ సకనల కరతం|\d+ సకను కరతం|\d+ గంట కరతం|\d+ నలల కరతం|\d+ రజు కరతం|\d+ వరం కరతం|\d+ వరల కరతం|\d+ సంవతసరంల|\d+ సంవతసరలల|\d+ గం కరతం|\d+ నమ కరతం|\d+ నల కరతం|\d+ సం కరతం|\d+ సక కరతం|\d+ గంటలల|\d+ నమషంల|\d+ నమషలల|\d+ రజులల|\d+ సకనలల|\d+ సకనుల|\d+ గంటల|\d+ నలలల|\d+ రజుల|\d+ వరంల|\d+ వరలల|\d+ సక ల|\d+ గంల|\d+ నమల|\d+ నలల|\d+ సంల)(\z|\W|_)`),
	...
	RxKnownWords:    regexp.MustCompile(`(?i)^(.*?(?:\A|\W|_|\d))(తదుపర సంవతసరం|గత సంవతసరం|ఈ సంవతసరం|తదుపర వరం|తదుపర నల|గురువరం|పరసతుతం|మంగళవరం|శుకరవరం|సంవతసరం|ఈ నమషం|గత వరం|బుధవరం|సపటంబర|అకటబర|ఆగసటు|ఆదవరం|ఈ గంట|ఈ రజు|ఈ వరం|గత నల|డసంబర|నమషము|నవంబర|ఫబరవర|శనవరం|సమవరం|ఈ నల|ఏపరల|గురు|జనవర|మంగళ|వరము|శుకర|సకను|సపటం|gmt|utc|అకట|ఏపర|గంట|జుల|జూన|డసం|దనం|ననన|నవం|ఫబర|బుధ|మరచ|రపు|\+|\.|\[|\]|\||am|pm|ఆగ|ఆద|గం|జన|నమ|నల|శన|సం|సక|సమ| |'|,|-|/|:|;|@|z|ద|న|మ|వ)((?:\z|\W|_|\d).*)$`),
})
