...
var en_CA_Locale = merge(&en_Locale, LocaleData{
	...
	RxCombined:      regexp.MustCompile(`(?i)(\A|[^\pL\pM\d]|_)(\d+ decades? ago|\d+ minutes ago|\d+ seconds ago|in \d+ decades?|\d+ minute ago|\d+ months ago|\d+ second ago|in \d+ minutes|in \d+ seconds|\d+ hours ago|\d+ month ago|\d+ weeks ago|\d+ years ago|in \d+ minute|in \d+ months|in \d+ second|\d+ days ago|\d+ hour ago|\d+ mins ago|\d+ secs ago|\d+ week ago|\d+ year ago|in \d+ hours|in \d+ month|in \d+ weeks|in \d+ years|\d+ day ago|\d+ hrs ago|\d+ min ago|\d+ mos ago|\d+ sec ago|\d+ wks ago|\d+ yrs ago|in \d+ days|in \d+ hour|in \d+ mins|in \d+ secs|in \d+ week|in \d+ year|\d+ hr ago|\d+ mo ago|\d+ wk ago|\d+ yr ago|in \d+ day|in \d+ hrs|in \d+ min|in \d+ mos|in \d+ sec|in \d+ wks|in \d+ yrs|in \d+ hr|in \d+ mo|in \d+ wk|in \d+ yr)(\z|[^\pL\pM\d]|_)`),
	RxExactCombined: regexp.MustCompile(`(?i)^(\d+ decades? ago|\d+ minutes ago|\d+ seconds ago|in \d+ decades?|\d+ minute ago|\d+ months ago|\d+ second ago|in \d+ minutes|in \d+ seconds|\d+ hours ago|\d+ month ago|\d+ weeks ago|\d+ years ago|in \d+ minute|in \d+ months|in \d+ second|\d+ days ago|\d+ hour ago|\d+ mins ago|\d+ secs ago|\d+ week ago|\d+ year ago|in \d+ hours|in \d+ month|in \d+ weeks|in \d+ years|\d+ day ago|\d+ hrs ago|\d+ min ago|\d+ mos ago|\d+ sec ago|\d+ wks ago|\d+ yrs ago|in \d+ days|in \d+ hour|in \d+ mins|in \d+ secs|in \d+ week|in \d+ year|\d+ hr ago|\d+ mo ago|\d+ wk ago|\d+ yr ago|in \d+ day|in \d+ hrs|in \d+ min|in \d+ mos|in \d+ sec|in \d+ wks|in \d+ yrs|in \d+ hr|in \d+ mo|in \d+ wk|in \d+ yr)$`),
})
...
var en_SG_Locale = merge(&en_Locale, LocaleData{
	...
	RxCombined:      regexp.MustCompile(`(?i)(\A|[^\pL\pM\d]|_)(\d+ decades? ago|\d+ minutes ago|\d+ seconds ago|in \d+ decades?|\d+ minute ago|\d+ months ago|\d+ second ago|in \d+ minutes|in \d+ seconds|\d+ hours ago|\d+ month ago|\d+ weeks ago|\d+ years ago|in \d+ minute|in \d+ months|in \d+ second|\d+ days ago|\d+ hour ago|\d+ week ago|\d+ year ago|in \d+ hours|in \d+ month|in \d+ weeks|in \d+ years|\d+ day ago|\d+ min ago|\d+ mth ago|\d+ sec ago|in \d+ days|in \d+ hour|in \d+ week|in \d+ year|\d+ hr ago|\d+ mo ago|\d+ wk ago|\d+ yr ago|in \d+ day|in \d+ min|in \d+ mth|in \d+ sec|in \d+ hr|in \d+ mo|in \d+ wk|in \d+ yr)(\z|[^\pL\pM\d]|_)`),
	RxExactCombined: regexp.MustCompile(`(?i)^(\d+ decades? ago|\d+ minutes ago|\d+ seconds ago|in \d+ decades?|\d+ minute ago|\d+ months ago|\d+ second ago|in \d+ minutes|in \d+ seconds|\d+ hours ago|\d+ month ago|\d+ weeks ago|\d+ years ago|in \d+ minute|in \d+ months|in \d+ second|\d+ days ago|\d+ hour ago|\d+ week ago|\d+ year ago|in \d+ hours|in \d+ month|in \d+ weeks|in \d+ years|\d+ day ago|\d+ min ago|\d+ mth ago|\d+ sec ago|in \d+ days|in \d+ hour|in \d+ week|in \d+ year|\d+ hr ago|\d+ mo ago|\d+ wk ago|\d+ yr ago|in \d+ day|in \d+ min|in \d+ mth|in \d+ sec|in \d+ hr|in \d+ mo|in \d+ wk|in \d+ yr)$`),
