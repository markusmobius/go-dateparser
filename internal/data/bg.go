...
var bg_Locale = merge(nil, LocaleData{
	...
	Simplifications: []ReplacementData{
		{regexp.MustCompile(`(?i)(\A|\W|_)един(\z|\W|_)`), "${1}1${2}"},
		{regexp.MustCompile(`(?i)(\A|\W|_)два(\z|\W|_)`), "${1}2${2}"},
