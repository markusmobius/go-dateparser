...
func init() {
	da_Locale = merge(nil, LocaleData{
		...
		Simplifications: []ReplacementData{
			...
			{regexp.MustCompile(`(?i)(\A|[^\pL\pM\d]|_)(\d+[.,]?\d*)\s*hr(s?)(\z|[^\pL\pM\d]|_)`), "${1}${2} time${3}${4}"},
			{regexp.MustCompile(`(?i)(\A|[^\pL\pM\d]|_)(\d+[.,]?\d*)\s*min(s?)(\z|[^\pL\pM\d]|_)`), "${1}${2} minut${3}${4}"},
			{regexp.MustCompile(`(?i)(\A|[^\pL\pM\d]|_)(\d+[.,]?\d*)\s*sec(s?)(\z|[^\pL\pM\d]|_)`), "${1}${2} sekund${3}${4}"},
