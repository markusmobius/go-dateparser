...
var yi_Locale = merge(nil, LocaleData{
	...
	RxCombined:      regexp.MustCompile(`(?i)(\A|\W|_)(אין \d+ טאג ארום|אין \d+ טעג ארום|איבער \d+ חדשים|איבער \d+ חודש|איבער \d+ יאר|פאר \d+ חדשים|פאר \d+ חודש|פאר \d+ יאר)(\z|\W|_)`),
