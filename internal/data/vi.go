...
var vi_Locale = merge(nil, LocaleData{
	...
	DateOrder:    "DMY",
	SkipWords:    []string{"'", ",", "-", ".", "/", ";", "@", "[", "]", "|"},
	PertainWords: []string{"luc"},
	Simplifications: []ReplacementData{
		{regexp.MustCompile(`(?i)(\A|\W|_)(?:ngay|nam)\s(\d+)(\z|\W|_)`), "${1}${2}${3}"},
	},
	...
	RxCombined:      regexp.MustCompile(`(?i)(\A|\W|_)(sau \d+ thang nua|sau \d+ giay nua|sau \d+ ngay nua|sau \d+ phut nua|sau \d+ tuan nua|\d+ thang truoc|sau \d+ gio nua|sau \d+ nam nua|\d+ giay truoc|\d+ ngay truoc|\d+ phut truoc|\d+ tuan truoc|\d+ gio truoc|\d+ nam truoc)(\z|\W|_)`),
	...
	RxKnownWords:    regexp.MustCompile(`(?i)^(.*?(?:\A|\W|_|\d))(thang muoi hai|thang muoi mot|giay đong ho|thang truoc|nguyen ban|thang chin|thang muoi|tuan truoc|nam ngoai|thang bay|thang hai|thang mot|thang nam|thang nay|thang sau|thang tam|truoc đay|ban ngay|cach đay|chu nhat|hang nhi|ngay mai|phut nay|thang 10|thang 11|thang 12|thang ba|thang tu|tuan nay|tuan sau|bay gio|gio nay|hom nay|hom qua|nam nay|nam sau|thang 1|thang 2|thang 3|thang 4|thang 5|thang 6|thang 7|thang 8|thang 9|thu bay|thu hai|thu nam|thu sau|tuan le|thg 10|thg 11|thg 12|thu ba|thu tu|thang|thg 1|thg 2|thg 3|thg 4|thg 5|thg 6|thg 7|thg 8|thg 9|thu 1|thu 2|thu 3|thu 4|thu 5|thu 6|thu 7|trong|truoc|buoi|chut|giay|ngay|phut|th 2|th 3|th 4|th 5|th 6|th 7|tuan|gio|gmt|lat|luc|nam|thg|utc|\+|\.|\[|\]|\||am|ch|cn|pm|sa| |'|,|-|/|:|;|@|z)((?:\z|\W|_|\d).*)$`),
})
