...
var ckb_Locale = LocaleData{
	...
	Translations: map[*regexp.Regexp]string{
		...
		regexp.MustCompile(`(\A|\W|_)بن(\z|\W|_)`):            "${1}am${2}",
		regexp.MustCompile(`(\A|\W|_)نیسان(\z|\W|_)`):         "${1}april${2}",
		regexp.MustCompile(`(\A|\W|_)ئاب(\z|\W|_)`):           "${1}august${2}",
		regexp.MustCompile(`(\A|\W|_)day(\z|\W|_)`):           "${1}day${2}",
		regexp.MustCompile(`(\A|\W|_)کانونی یەکەم(\z|\W|_)`):  "${1}december${2}",
		regexp.MustCompile(`(\A|\W|_)شوبات(\z|\W|_)`):         "${1}february${2}",
		regexp.MustCompile(`(\A|\W|_)ھەینی(\z|\W|_)`):         "${1}friday${2}",
		...
		regexp.MustCompile(`(\A|\W|_)تەمووز(\z|\W|_)`):        "${1}july${2}",
		regexp.MustCompile(`(\A|\W|_)حوزەیران(\z|\W|_)`):      "${1}june${2}",
		regexp.MustCompile(`(\A|\W|_)ئازار(\z|\W|_)`):         "${1}march${2}",
		regexp.MustCompile(`(\A|\W|_)ئایار(\z|\W|_)`):         "${1}may${2}",
		regexp.MustCompile(`(\A|\W|_)دووشەممە(\z|\W|_)`):      "${1}monday${2}",
		...
		regexp.MustCompile(`(\A|\W|_)دن(\z|\W|_)`):            "${1}pm${2}",
		regexp.MustCompile(`(\A|\W|_)شەممە(\z|\W|_)`):         "${1}saturday${2}",
		regexp.MustCompile(`(\A|\W|_)second(\z|\W|_)`):        "${1}second${2}",
		regexp.MustCompile(`(\A|\W|_)ئەیلوول(\z|\W|_)`):       "${1}september${2}",
		regexp.MustCompile(`(\A|\W|_)یەکشەممە(\z|\W|_)`):      "${1}sunday${2}",
		regexp.MustCompile(`(\A|\W|_)پێنجشەممە(\z|\W|_)`):     "${1}thursday${2}",
		regexp.MustCompile(`(\A|\W|_)سێشەممە(\z|\W|_)`):       "${1}tuesday${2}",
		regexp.MustCompile(`(\A|\W|_)چوارشەممە(\z|\W|_)`):     "${1}wednesday${2}",
