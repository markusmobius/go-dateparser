...
func pfpParse(cfg *setting.Configuration, s string) (DateData, error) {
	...
	locales, err := pfpDetector.Detect(str)
	if err != nil {
		return DateData{}, err
	}
	...
	for _, locale := range locales {
		...
		dt := parseFreshnessPattern(cfg, translated)
...
func Test_parseFreshnessPattern_pastAndFutureDates(t *testing.T) {
	...
	pastTimes := []testScenario{
		...
		{"three week ago", pfpDiff{"week": -3}, Week},
		...
		{"1 année, 09 mois, 01 semaines", pfpDiff{"year": -1, "month": -9, "week": -1}, Week},
		...
		{"1 Jahr, 09 Monate, 01 Wochen", pfpDiff{"year": -1, "month": -9, "week": -1}, Week},
		...
		{"1 anno, 09 mesi, 01 settimane", pfpDiff{"year": -1, "month": -9, "week": -1}, Week},
		...
		{"1 yıl, 09 ay, 01 hafta", pfpDiff{"year": -1, "month": -9, "week": -1}, Week},
		...
		{"1 год, 09 месяцев, 01 недель", pfpDiff{"year": -1, "month": -9, "week": -1}, Week},
		...
		{"1 rok, 09 měsíců, 01 týdnů", pfpDiff{"year": -1, "month": -9, "week": -1}, Week},
		...
		{"1 ปี 9 เดือน 1 สัปดาห์", pfpDiff{"year": -1, "month": -9, "week": -1}, Week},
		...
		{"1 год, 09 месяцаў, 01 тыдзень", pfpDiff{"year": -1, "month": -9, "week": -1}, Week},
		...
		{"преди седмица", pfpDiff{"week": -1}, Week},
		...
		{"1 वर्ष, 8 महीने, 2 सप्ताह", pfpDiff{"year": -1, "month": -8, "week": -2}, Week},
		...
		// az-Latn
		{"1 il öncə 2 ay öncə 3 həftə öncə", pfpDiff{"year": -1, "month": -2, "week": -3}, Week},
		...
		// bg
		{"преди 3 месеца преди 2 седм", pfpDiff{"month": -3, "week": -2}, Week},
		// bn
		...
		{"prije 13 godina prije 3 sed", pfpDiff{"year": -13, "week": -3}, Week},
		// bs
		...
		// ca
		{"fa 4 setmanes fa 5 segon", pfpDiff{"week": -4, "second": -5}, Week},
		...
		// cy
		{"5 wythnos yn ôl", pfpDiff{"week": -5}, Week},
		...
		// hr
		{"prije 3 tjedana", pfpDiff{"week": -3}, Week},
		// hsb
		...
		// it
		{"5 settimana fa", pfpDiff{"week": -5}, Week},
		// jgo
		...
		// km
		{"11 សប្ដាហ៍​មុន", pfpDiff{"week": -11}, Week},
		// kn
		...
		// ml
		{"3 ആഴ്ച മുമ്പ്", pfpDiff{"week": -3}, Week},
		// mn
		...
		// ne
		{"23 हप्ता पहिले", pfpDiff{"week": -23}, Week},
		// nl
		...
		// pa-Guru
		{"23 ਹਫ਼ਤੇ ਪਹਿਲਾਂ", pfpDiff{"week": -23}, Week},
		// pa
		{"7 ਸਾਲ ਪਹਿਲਾਂ", pfpDiff{"year": -7}, Year},
		// ro
		{"acum 56 de secunde", pfpDiff{"second": -56}, Day},
		// sah
		{"2 нэдиэлэ анараа өттүгэр", pfpDiff{"week": -2}, Week},
		// se
		...
		// sr-Latn
		{"pre 2 nedelje", pfpDiff{"week": -2}, Week},
		// sr
		...
		// te
		{"36 వారాల క్రితం", pfpDiff{"week": -36}, Week},
		// to
		...
		// uz-Cyrl
		{"10 ҳафта олдин", pfpDiff{"week": -10}, Week},
		// uz-Latn
	...
	futureTimes := []testScenario{
		...
		{"En 1 année, 09 mois, 01 semaines", pfpDiff{"year": 1, "month": 9, "week": 1}, Week},
		...
		{"im 1 Jahr, 09 Monate, 01 Wochen", pfpDiff{"year": 1, "month": 9, "week": 1}, Week},
		...
		{"haftaya", pfpDiff{"week": 1}, Week},
		{"gelecek hafta", pfpDiff{"week": 1}, Week},
		...
		{"1 वर्ष, 5 महीने, 1 सप्ताह में", pfpDiff{"year": 1, "month": 5, "week": 1}, Week},

		// af
		{"oor 10 jaar", pfpDiff{"year": 10}, Year},
		{"oor 5 min 3 sek", pfpDiff{"minute": 5, "second": 3}, Day},
		// am
		{"በ2 ሳምንታት ውስጥ", pfpDiff{"week": 2}, Week},
		...
		{"10 nädala pärast", pfpDiff{"week": 10}, Week},
		// eu
		...
		// fur
		{"ca di 15 setemanis", pfpDiff{"week": 15}, Week},
		...
		{"i gceann 12 scht", pfpDiff{"week": 12}, Week},
		// gd
		...
		{"en 14 semanas", pfpDiff{"week": 14}, Week},
		// gu
		...
		{"51 շաբաթից", pfpDiff{"week": 51}, Week},
		// id
		...
		{"tra 16 settimane", pfpDiff{"week": 16}, Week},
		// jgo
		// {"nǔu ŋgu" 10", pfpDiff{"year": 10}, Year},
		{"nǔu ŋgap-mbi 11", pfpDiff{"week": 11}, Week},
		// ka
		{"5 საათში", pfpDiff{"hour": 5}, Day},
		{"3 კვირაში", pfpDiff{"week": 3}, Week},
		// kea
		...
		// kl
		{"om 15 sapaatip-akunnera", pfpDiff{"week": 15}, Week},
		{"om 23 nalunaaquttap-akunnera", pfpDiff{"hour": 23}, Day},
		// km
		{"2 នាទីទៀត", pfpDiff{"minute": 2}, Day},
		{"5 សប្ដាហ៍ទៀត", pfpDiff{"week": 5}, Week},
		// kn
		{"10 ವಾರದಲ್ಲಿ", pfpDiff{"week": 10}, Week},
		...
		// mk
		{"за 16 седмици", pfpDiff{"week": 16}, Week},
		{"за 2 месеци", pfpDiff{"month": 2}, Month},
		// ml
		{"5 ആഴ്ചയിൽ", pfpDiff{"week": 5}, Week},
		...
		// nl
		{"over 3 weken", pfpDiff{"week": 3}, Week},
		{"over 12 seconden", pfpDiff{"second": 12}, Day},
		// nn
		{"om 7 uker", pfpDiff{"week": 7}, Week},
		...
		// sk
		{"o 23 týždňov", pfpDiff{"week": 23}, Week},
		// sl
		...
		{"za 14 nedelja", pfpDiff{"week": 14}, Week},
		// sr
		{"за 18 недеља", pfpDiff{"week": 18}, Week},
		{"за 5 месеци", pfpDiff{"month": 5}, Month},
		// sv
		{"om 7 veckor", pfpDiff{"week": 7}, Week},
		...
		// te
		{"3 వారాల్లో", pfpDiff{"week": 3}, Week},
	...
	for _, test := range tests {
		...
		// Parse date time
		dt, err := pfpParse(&pfpConfig, test.String)
...
func Test_parseFreshnessPattern_invalidDates(t *testing.T) {
	dt, err := pfpParse(&pfpConfig, "15th of Aug, 2014 Diane Bennett")
	assert.Nil(t, err)
